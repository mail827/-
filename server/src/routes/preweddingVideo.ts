...
const SELFIE_CONCEPTS: { id: string; prompt: string; subScenes?: string[] }[] = [
  ...
  { id: 'summer_film', prompt: 'place this person standing on sidewalk in front of old single-screen cinema with hand-painted movie poster board and faded red awning, late afternoon golden sun on quiet street, wearing deep navy school uniform, warm celluloid film grain, face clearly visible, photorealistic, 8k', subScenes: ['place this person walking down quiet shopping street with small old storefronts colored awnings, warm afternoon golden rim light, wearing navy school uniform, face clearly visible, photorealistic, 8k', 'place this person standing at old iron railing of pedestrian bridge over quiet river at late afternoon, low warm sun, wearing navy school uniform, face clearly visible, photorealistic, 8k', 'place this person sitting on school staircase at golden hour, deep golden horizontal light, wearing navy school uniform, face clearly visible, photorealistic, 8k', 'place this person in school bicycle parking area among rows of silver bicycles, late afternoon long shadows, wearing navy school uniform, face clearly visible, photorealistic, 8k', 'place this person running down riverside embankment at sunset toward golden light, tall grass catching amber light, wearing navy school uniform, face clearly visible, photorealistic, 8k'] },
  { id: 'lily_choucho', prompt: 'place this person standing on narrow dirt path between vast green rice paddy fields under heavy overcast grey sky, oversaturated green, wearing muted ash grey school blazer with tartan skirt or charcoal trousers, white earphone in one ear, digital video texture, face clearly visible, photorealistic, 8k', subScenes: ['place this person walking alone down long school corridor with old wooden floor, repeating rectangles of grey window light creating alternating bars, wearing grey school blazer olive green tie, earphone cord trailing, face clearly visible, photorealistic, 8k', 'place this person sitting behind school building against stained concrete wall with green moss, wearing grey blazer, sharing earphones, flat grey light, face clearly visible, photorealistic, 8k', 'place this person in empty classroom by rain-streaked window, green trees blurred outside, wearing grey blazer white shirt, face clearly visible, photorealistic, 8k', 'place this person at small suburban train station platform at dusk, single fluorescent tube under shelter, wearing grey blazer, silhouette against blue-grey sky, face clearly visible, photorealistic, 8k', 'place this person lying on green grass beside rice paddy path, grey blazer spread open white shirt, earphone buds in, looking up at sky, oversaturated green, face clearly visible, photorealistic, 8k'] },
  ...
  { id: 'age_of_innocence', prompt: 'place this person seated in a private velvet-lined opera box overlooking a vast 1880s Gilded Age opera house, deep crimson velvet upholstered chair, dark mahogany box railing, gas-lit crystal chandelier glowing far in the distance beyond the box, facing forward toward the opera stage below in three-quarter profile, warm amber gaslight from the chandelier washing from the front, deep velvet shadow behind in the box, bone-white garment glowing against crimson velvet interior, face clearly visible, cinematic film still 50mm celluloid grain, photorealistic, 8k', subScenes: ['place this person seated alone in a private velvet-lined opera box overlooking a vast 1880s Gilded Age opera house, deep crimson velvet upholstered chairs, dark mahogany railing, gas-lit crystal chandelier glowing far in the distance, facing forward toward opera stage in three-quarter profile, warm amber gaslight washing from front, deep velvet shadow behind, face clearly visible, cinematic film still 50mm celluloid grain, photorealistic, 8k', 'place this person alone in strict side profile in a private opera box head turned fully to the left so camera sees only left side of face from ear to nose tip, holding a mother-of-pearl opera glass up to the right eye with both gloved hands but the opera glass angled sharply sideways pointed across the opera house toward the opposite box not toward the stage, lips softly parted in focused concentration, warm amber gaslight from distant chandelier glowing out of focus upper-left, crimson velvet box wall in deep red shadow, face lit by soft amber bounce, cinematic film still 85mm celluloid grain, photorealistic, 8k', 'place this person alone halfway up a grand curved marble staircase inside an 1880s Metropolitan Opera House lobby, white Carrara marble steps with dark mahogany bannister curving behind, massive crystal chandelier above glowing in warm gaslight, gilded mirror on far wall reflecting distant figures in evening dress as blurred spots of light, one hand resting lightly on mahogany bannister body angled three-quarter to camera looking up toward top of stairs, warm amber gaslight from chandelier above bathing from overhead marble glowing honey-gold, cinematic film still 35mm low angle celluloid grain, photorealistic, 8k', 'place this person alone in a Victorian glass conservatory attached to a Gilded Age townhouse standing in three-quarter profile between tall potted palms and a white lattice trellis, holding a single long-stemmed yellow rose in the gloved right hand at chest height gaze directed down at the rose with quiet concentration, tall arched glass panels behind with filtered late afternoon sunlight streaming through creating soft cool blue-green ambient light filtered by glass and leaves into dappled patterns, yellow rose the only saturated color in otherwise monochrome cool green-white scene, black-and-white tiled conservatory floor, cinematic film still 85mm celluloid grain, photorealistic, 8k', 'place this person alone in a Gilded Age private study standing before a large marble fireplace with an orange flame burning low, mahogany panelled walls lined with leather-bound books behind, a deep forest green leather wing chair in soft focus, standing in three-quarter profile facing the fire right hand resting on the marble mantelpiece holding a folded ivory letter card hanging loosely between fingers over the flame but not yet dropping it, face lit from below by amber firelight expression still and resigned, rest of study falling into deep cool shadow behind, cinematic film still 50mm celluloid grain, photorealistic, 8k', 'place this person alone seated at a small round walnut side table in a dimly lit Gilded Age drawing room in three-quarter profile gaze directed down at the table surface with quiet focus lips softly parted, both hands completely bare with no gloves on two long bone-white silk opera-length gloves already removed and lying empty and flat on the walnut table surface beside the right hand crumpled softly like shed skins, bare right hand extended forward fingertips just touching the petals of a single long-stemmed yellow rose lying across the walnut table the rose head turned toward the bare hand, single tungsten reading lamp on the table casting warm amber light upward onto face and hands and the rose walnut table glowing honey the rose saturated yellow in the pool of lamplight drawing room behind falling into deep soft-focus mahogany shadow, cinematic film still 85mm celluloid grain, photorealistic, 8k', 'place this person alone high up on a rolling wooden library ladder in a two-story Gilded Age private library standing on the fifth rung reaching up with the right hand to slide a leather-bound book partway out of a tall mahogany bookshelf face in three-quarter profile looking at the book spine, full skirt cascading down the ladder rungs veil trailing down to the floor below, endless floor-to-ceiling bookshelves filled with leather-bound volumes behind in dark forest green and oxblood bindings brass ladder rail curving along shelves, warm afternoon sunlight pours in from unseen tall window camera-right casting sharp diagonal beam across library dust motes hitting gown and books in warm amber deep cool shadow on opposite side, cinematic film still 35mm low angle celluloid grain, photorealistic, 8k', 'place this person alone seated at a Gilded Age mahogany writing desk in a private study three-quarter profile to camera body angled slightly toward desk face in profile looking down at desk objects with still concentration, on desk before them a single long-stemmed yellow rose lying diagonally across polished surface a silver dip pen resting beside an opened glass inkwell with dark blue-black ink a folded ivory letter card lying half-tucked under the rose, right hand holding silver pen poised above the letter card as if about to write or about to stop pen suspended mid-air not yet touching paper left hand resting flat on desk beside the rose, single tungsten reading lamp on desk casting warm amber pool across desk surface and up onto face from below face half-lit amber half in soft shadow mahogany-panelled study walls falling into deep cool darkness, cinematic film still 50mm celluloid grain, photorealistic, 8k'] },
  { id: 'blurred_spring', prompt: 'place this person on a sunlit 1970s American suburban backyard lawn with white clapboard house and white picket fence behind, warm morning sunlight filtering through oak tree leaves overhead casting dappled gold patterns, face clearly visible in three-quarter profile, Kodak Gold 200 celluloid grain halation bloom Sofia Coppola Virgin Suicides aesthetic sun-bleached palette warm amber cast, cinematic film still 50mm, photorealistic, 8k', subScenes: ['place this person standing on wooden back porch of 1970s American suburban white clapboard house with faded green shutters screen door with metal mesh slightly ajar behind, warm morning sunlight from camera-right filters through oak tree leaves overhead casting dappled gold patterns across porch floorboards, face clearly visible in three-quarter profile looking outward toward backyard, Kodak Gold 200 celluloid grain warm halation bloom on white porch edges, 50mm lens, photorealistic, 8k', 'place this person standing barefoot on sunlit backyard lawn face in three-quarter profile looking down at own bare feet on cool grass lips softly parted one foot slightly pointed in instinctive ballet fifth position from memory, dusty sage green ballet flats discarded on grass two meters behind clearly visible, faded red Schwinn-style bicycle leans against white picket fence in soft-focus background, warm mid-morning sun from upper-right halation bloom shadow short and soft in bright grass, Kodak Gold 200 celluloid grain sun-bleached pastel palette warm amber cast, 85mm lens, photorealistic, 8k', 'place this person standing beside a faded red Schwinn-style bicycle in front of 1970s suburban detached garage with peeling white paint and faded green trim, one hand on handlebar gaze directed down at Polaroid photograph resting in wicker front basket among loose white flowers and folded paper map small private half-smile, warm late-morning sun from camera-left washes white garage wall in blown-out bleached cream halation bloom, Kodak Gold 200 celluloid grain, 50mm lens, photorealistic, 8k', 'place this person sitting on interior wooden window bench knees folded up body turned toward open window in three-quarter profile forehead resting lightly against wooden window frame looking out at sunlit backyard, white lace curtains with delicate floral pattern billow gently around her lifted by summer breeze curtain edges catching bright backlight dissolving into overexposed white, extreme blown-out noon sunlight outside creates halo of pure white light around silhouette room interior behind in soft warm honey shadow glimpse of flowered wallpaper, Kodak Gold 200 celluloid grain strong halation bloom around entire silhouette overexposed two stops, 85mm lens, photorealistic, 8k', 'place this person squatting low on sunlit suburban backyard lawn with both feet flat on grass and knees bent deep body compact in relaxed casual crouch not kneeling holding Polaroid photograph in both hands in front of chest turning it toward own face gaze down at Polaroid soft private half-smile face three-quarter to camera with both eyes and nose clearly visible not obscured by hair, faded red Schwinn-style bicycle lying on side on grass two meters behind white picket fence and clapboard suburban house behind, peak noon sun overhead washes scene in blown-out warm white-gold grass pale bleached chartreuse linen suit glowing ivory-cream, Kodak Gold 200 celluloid grain halation bloom 50mm lens overexposed, photorealistic, 8k', 'place this person captured mid-motion running through rotating oscillating garden sprinkler on sunlit backyard lawn water arcs spraying in bright diagonal lines creating rainbow in air, hair getting wet clothes visibly damp from spray barefoot on wet grass, water droplets catching extreme overhead noon sun create thousands of tiny bright spots like scattered diamonds, face caught mid-laugh angled toward sun-sparkled water not at camera, Kodak Gold 200 celluloid grain strong halation bloom on every water droplet soft motion blur 35mm lens overexposed, photorealistic, 8k', 'place this person standing in center of 1970s suburban backyard lawn at magic hour barefoot on cooling grass face tilted up toward sky watching changing evening light eyes half-closed lips softly parted arms hanging naturally at sides, white picket fence and clapboard suburban house silhouetted behind against deep rose-magenta fading to lavender fading to pale peach twilight sky first fireflies tiny specks of warm glow visible above lawn, warm golden-magenta magic hour sun just above horizon casts long soft pink shadows across lawn entire figure bathed in warm rose-amber light, Kodak Gold 200 celluloid grain halation bloom softening horizon line, 50mm lens, photorealistic, 8k'] },
  { id: 'rosewater_ballet', prompt: 'place this person inside an Orchard House-style 1860s New England wooden living room or at New England rocky Atlantic shore in cool-warm balanced rose-cream natural light with dusty pink undertones, face clearly visible, keeping original front bangs exactly as shown in reference image only back and length of hair transforms into black shoulder-length hippie jelly perm wavy hair with soft S-curl waves, Tiffen Classic Soft and Rose FX diffusion filters Kodak VISION3 500T film grain Little Women Greta Gerwig aesthetic pink-rose harmony true rose color NOT yellow amber, cinematic film still 50mm, photorealistic, 8k', subScenes: ['place this person inside Orchard House-style 1860s New England wooden living room warm wooden floor planks soft cream wallpaper with faint floral pattern lace curtains at tall windows stone fireplace dusty green velvet wingback armchair cool morning daylight with soft peachy undertone pours through lace curtains gentle dappled patterns across wooden floor small flames in fireplace adding gentle warm glow balanced cool-warm rose-cream atmosphere, face clearly visible in three-quarter profile, keeping original front bangs exactly only back and length in black hippie jelly perm waves, Tiffen Classic Soft and Rose FX Kodak VISION3 500T film grain, 35mm lens, photorealistic, 8k', 'place this person alone seated at small wooden writing desk in sloped-ceiling attic writing room of New England wooden house body in three-quarter profile to camera leaning forward over desk writing with quill pen on sheet of cream paper full attention on writing not at camera, scattered across desk glass inkwell with dark brown-black ink stack of cream manuscript pages with elegant copperplate handwriting second quill pen small brass oil lamp turned off, soft cool-warm balanced morning light from sloped attic window pours diagonally onto hair and shoulder and manuscript pages creating gentle peachy-cream beam filled with visible floating dust motes rest of attic in soft rose-cream shadow of sloped wooden beams never heavy amber, keeping original front bangs exactly only back and length in black hippie jelly perm waves, Tiffen Classic Soft and Rose FX Kodak VISION3 500T film grain, 85mm lens, photorealistic, 8k', 'place this person captured mid-motion descending wooden staircase in New England 1860s house right foot stepping down onto lower step left hand skimming along wooden bannister rail other hand lifting full skirt or trouser hem slightly so as not to trip on steps body angled three-quarter to camera looking down at next step with focused energy small private half-smile mid-action not posed hair flowing from descent movement, soft cream wallpaper with faint floral pattern on staircase wall framed oil painting of New England landscape partially visible wooden bannister curving down, mid-morning cool-warm balanced daylight from unseen window below bathes staircase in soft peachy-cream tones with pink undertones, keeping original front bangs exactly only back and length in black hippie jelly perm waves, Tiffen Classic Soft and Rose FX Kodak VISION3 500T film grain, 50mm lens, photorealistic, 8k', 'place this person standing outside wooden front door of white clapboard New England 1860s house on stone front step in three-quarter profile to camera one hand reaching toward small wooden mailbox mounted beside door placing folded cream letter into mailbox other hand at side gaze directed at mailbox with quiet focus lips softly closed, white painted wooden door with brass knocker behind small glass panes revealing soft interior shadow climbing ivy partially on clapboard wall, soft peachy-cream late morning light from camera-right white house wall catching gentle pink daylight reflection balanced cool-warm light no heavy amber cast, Tiffen Classic Soft and Rose FX Kodak VISION3 500T film grain rose-linen peachy palette, 50mm lens, photorealistic, 8k', 'place this person walking barefoot along edge of calm Atlantic shore of New England rocky coast captured mid-stride walking slowly toward water edge where small foam waves reach wet sand body in three-quarter back angle to camera right foot stepping onto damp sand left foot trailing in drier sand behind ballet slippers abandoned in sand two meters behind clearly visible face in profile turned slightly toward horizon looking at sea with quiet joy lips softly parted hair softly blown by sea breeze, calm flat sea stretches to horizon with small white foam waves large gray granite boulders at far right distant rocky New England coastline silhouette few seagulls in sky, late afternoon golden hour sun from camera-right at low angle gentle long shadows sky glowing in soft dusty rose-peach gradient with pale lavender-blue at horizon naturally harmonizing with pink sky tones NOT yellow amber, keeping original front bangs exactly only back and length in black hippie jelly perm waves, Tiffen Classic Soft and Rose FX Kodak VISION3 500T film grain celluloid grain, 50mm lens, photorealistic, 8k', 'place this person shown from behind standing at tall wooden-framed window of New England 1860s house facing window with forehead almost touching cold glass right hand resting flat on glass at shoulder height left hanging at side, outside window soft snow falls in gentle white flakes across dim New England winter yard dusk light pale dusty blue-lavender with rose-peach undertones at horizon where last daylight lingers single naked oak tree black silhouette wooden fence dusted in white snow, room interior dim lit only by single oil lamp on small side table casting soft warm tungsten glow with rose-cream tones blending with cool blue-lavender snowfall light from window balanced mix of warm interior and cool exterior no heavy yellow amber, back view showing black hippie jelly perm wavy hair cascading down shoulders in soft waves original front bangs hidden by profile angle, Tiffen Classic Soft and Rose FX Kodak VISION3 500T film grain, 50mm lens, photorealistic, 8k', 'place this person alone seated at small wooden writing desk at evening both hands tying narrow dusty rose-pink satin ribbon around thick stack of cream manuscript pages looping ribbon into simple bow at top of stack face directed down at hands work with tender focused attention small private smile of completion lips softly parted beside manuscript stack glass inkwell now stoppered quill laid flat oil lamp lit with soft glow, two lit beeswax candles on desk in simple brass candlesticks casting warm flickering candle light on face and hands and paper stack soft cool blue-lavender evening light from small window behind balances warm candle glow with gentle cool accent preventing heavy amber cast attic behind in deep rose-mauve shadow, keeping original front bangs exactly only back and length in black hippie jelly perm waves, Tiffen Classic Soft and Rose FX Kodak VISION3 500T film grain, 85mm lens, photorealistic, 8k'] },
  { id: 'santorini_linen', prompt: 'place this person standing against a massive sunlit white limestone wall of an old Southern Italian cliff-top village, the wall rising ten meters high behind in bleached lime-washed stone with deep inset rectangular window shadows punched into the wall like dark voids, standing at the base of the wall in bright Mediterranean noon sun, face clearly visible, cinematic film still 35mm celluloid grain with halation bloom, photorealistic, 8k', subScenes: ['place this person standing at the base of a massive sunlit white limestone wall of an old Southern Italian cliff village, ten-meter lime-washed stone wall with deep inset rectangular window shadows, Mediterranean noon sun directly overhead blasting the white wall into blown-out highlights, heat haze rising from stone pavement, razor-sharp shadow under feet, face clearly visible, cinematic film still overexposed 35mm eye-level, celluloid grain halation bloom, photorealistic, 8k', 'place this person walking through a narrow sunlit alley between two towering white limestone walls of an old Italian cliff village barely two meters wide, captured mid-stride from three-quarter back angle, veil or jacket trailing behind across pale stone pavement, alley walls blasted into pure blown-out white by overhead sun, far end of alley glowing white rectangle as if ending in pure light, face clearly visible in profile, cinematic film still overexposed 50mm, celluloid grain halation bloom, photorealistic, 8k', 'place this person beneath a massive Romanesque white stone archway set into a thick white cliff-village wall, the archway five meters tall creating a tunnel of shadow, standing at the center where both sides of bright blown-out exterior light die into cool interior shadow, face clearly visible, cinematic film still 35mm eye-level, extreme contrast between shadow interior and blown-out exterior, celluloid grain, photorealistic, 8k', 'place this person standing on a small stone terrace at the edge of a white Italian cliff-top village leaning hip lightly against a white stone balustrade, beyond the balustrade the Mediterranean sea stretching out in blinding overexposed white-blue blending with the sky so the horizon line is completely dissolved, hot dry wind coming off the sea lifting fabric, side profile, face clearly visible, cinematic film still overexposed 50mm, celluloid grain, photorealistic, 8k', 'place this person standing alone at the edge of a white limestone cliff overlooking the Mediterranean far below in profile looking out to sea with wind blowing hair, late afternoon sun angled from the right still bright but warming, long soft shadow cast across white cliff stone, sea and sky behind still blown-out but with faint warm tone creeping in at horizon, face clearly visible, cinematic film still 50mm, celluloid grain, photorealistic, 8k', 'place this person standing inside an empty whitewashed Mediterranean room with white lime-plaster walls and white stone floor completely bare of furniture, one single tall arched window in the far wall open to the sea beyond, blinding white Mediterranean light pouring through the window bleaching the far wall and backlighting the figure into silhouette against the window, standing facing the window, veil or fabric drifting toward window as if pulled by sea air, face clearly visible in profile, cinematic film still 35mm, celluloid grain halation bloom around window, photorealistic, 8k', 'place this person standing at the very edge of a white limestone cliff-top overlooking the Mediterranean at late golden hour, sea and sky transformed into soft gradient of pale honey-gold at horizon fading through apricot to lavender above, warm low golden sun from camera-right bathing from behind casting long soft shadows toward camera, bone-white garments tinted warm rose-gold, cliff stone glowing amber, facing outward toward the vast sea horizon, cinematic film still 24mm wide lens shoulder height, warm rose-gold light celluloid grain, photorealistic, 8k'] },
  { id: 'nocturnal_animals', prompt: 'place this person standing perfectly still at the exact center of a vast minimalist brutalist gallery hall with raw concrete walls and polished black terrazzo floor, a single enormous abstract monochrome painting on the far wall, a hard cone spotlight dropping a circle of light from the ceiling, rest of the hall swallowed in deep black shadow, cinematic film still 35mm, photorealistic visible pores, celluloid grain, face clearly visible, 8k', subScenes: ['place this person standing at the exact center of a vast minimalist brutalist gallery hall, raw concrete walls polished black terrazzo floor six-meter ceiling, single enormous abstract monochrome painting on the far wall, hard cone ceiling spotlight dropping circle of light, rest of hall in deep black shadow, face clearly visible, cinematic film still 35mm celluloid grain, photorealistic, 8k', 'place this person standing inside a dark gallery space looking up at an enormous three-meter white marble abstract sculpture, small figure dwarfed by the massive glowing white marble beside them, hidden uplight rimming sculpture edges in cold white light, face lit only by reflected bounce off the marble, rest of gallery pitch black, face clearly visible, cinematic film still 50mm celluloid grain, photorealistic, 8k', 'place this person walking through an endless narrow marble corridor with deep navy painted walls and low ceiling, evenly spaced gold filament pendant lights running down the ceiling, marble floor reflecting warm amber glow, overhead bird-eye perspective, face clearly visible, cinematic film still 35mm celluloid grain, photorealistic, 8k', 'place this person standing inside a dark penthouse room facing a three-story floor-to-ceiling glass wall looking out at a vast Seoul night cityscape, faint ghosted reflection appearing on the glass surface showing the face overlaid on distant city lights, interior room in pitch black darkness, only light source is cold blue city glow, face clearly visible, cinematic film still 85mm celluloid grain, photorealistic, 8k', 'place this person seated in a deep emerald green velvet mid-century armchair in a modernist living room, a low black marble coffee table in front holding a wine glass, a black brass floor lamp with amber tungsten globe bulb behind the chair lighting one side of the face in warm glow, cool shadow on the other side, seated in profile, face clearly visible, cinematic film still 50mm celluloid grain, photorealistic, 8k', 'place this person seated inside a modern black sedan on a night highway, hands resting on lap, amber dashboard backlight glowing softly on lower half of face, streaks of cold sodium-orange street lamp light slipping across face through the windshield in rhythmic flashes, face clearly visible, cinematic film still 35mm celluloid grain, photorealistic, 8k', 'place this person reflected in a bathroom vanity mirror holding a scarlet red lipstick tube up to the lower lip retouching matte lipstick, dark black marble bathroom wall with matching brass wall sconce behind, single cold white LED strip light above mirror casting flat clinical light directly on face, every pore and freckle sharply visible, bathroom behind falling into soft dark shadow, face clearly visible in mirror, cinematic film still 85mm celluloid grain, photorealistic, 8k', 'place this person sitting at a corner table in a deep emerald green-walled fine dining restaurant at closing time all other tables empty and dark, a half-full red wine glass on the white linen the rim marked with a vivid scarlet lipstick imprint, a single warm brass pendant lamp directly above dropping amber spotlight, rest of emerald room falling into deep green-black shadow, face clearly visible, cinematic film still 50mm celluloid grain, photorealistic, 8k'] },
];

const GLAMOUR_FACE = 'Keep the person\'s facial features exactly the same as the reference image, including eye shape, eyelid fold, nose, lips, jawline, and face proportions. The face must be identical to the input photo. Natural proportionate head to body ratio with realistic skin texture. Every visible person must have a complete anatomically correct body with both arms ending in natural hands and both hands visible with five fingers each, no missing limbs no missing hands no amputated arms, sleeves must end with a visible hand not empty cuffs. In couple shots each person has their own two complete arms and two complete hands even when embracing or overlapping';
...
const GLAMOUR_OUTFIT_GROOM: Record<string, string> = {
  ...
  summer_film: 'wearing deep navy blue wool serge gakuran-style Japanese high school uniform with standing mandarin collar buttoned to top with five gold metal buttons in single vertical column, structured shoulders, white cotton shirt visible only at the collar edge beneath the buttoned gakuran, matching deep navy straight-leg trousers, black leather lace-up shoes, NOT wearing tuxedo NOT wearing suit NOT wearing blazer NOT wearing bow tie NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  lily_choucho: 'wearing muted ash grey wool school blazer with single button slim fit notch lapels and faded navy school crest embroidered on left chest pocket, white cotton dress shirt with point collar, thin muted olive green woven necktie in loose four-in-hand knot, dark charcoal grey wool straight-leg trousers, black leather oxford lace-up shoes, NOT wearing tuxedo NOT wearing suit with peak lapels NOT wearing bow tie NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  santorini_linen: 'wearing matte bone-white wool-silk blend double-breasted two-piece suit with structured squared shoulders and sharp wide peaked lapels in matching matte bone-white self-faced fabric not satin not shiny, slim jacket waist jacket length ending just below hip, six buttons covered in matching bone-white fabric visually disappearing into jacket surface, welt pockets at hip level with no flap, high-necked pure bone-white silk crepe band-collar shirt fastened to throat with single covered button no tie no bow tie no pocket square, slim straight-leg trousers in same matte bone-white wool-silk with clean single front pleat breaking cleanly at ankle, matte bone-white suede ankle boots in same exact color, single clear round-cut crystal boutonniere pinned on left lapel approximately one centimeter in diameter set with no visible metal appearing as a single frozen water drop, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  nocturnal_animals: 'wearing pure black wool grain de poudre double-breasted tuxedo jacket with six black satin-covered buttons and extreme wide satin-faced peak lapels extending past the shoulder line, heavily structured squared shoulders, high-waisted slim tapered trousers with black satin side-stripe, pure black silk satin collarless shirt buttoned to top with concealed placket and clean round neckline, single thin black grosgrain ribbon tied in flat knot at left side of neck with two short tails, single oversized irregular cream white baroque pearl pin on left lapel, black patent leather Chelsea boots with slight heel, NO bow tie NO pocket square NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  age_of_innocence: 'wearing bone-white silk-wool blend single-breasted two-piece suit with single covered button closure at natural waist and front closing cleanly down center with straight vertical seam, clean notched lapels in matching bone-white silk-wool self-faced not shiny slim proportions rising high toward collar, structured but natural shoulders jacket length ending just below hip with clean straight bottom hem welt pockets at hip no flap, high-necked bone-white silk crepe mandarin-collar shirt fastened cleanly to throat with single covered button at collar, slim straight-leg trousers in same bone-white silk-wool with clean single front pleat breaking cleanly at ankle, matte bone-white suede oxford shoes, single elongated teardrop-shaped cream pearl approximately fifteen millimeters long pinned at center of left lapel just below lapel notch hanging on a tiny invisible thread so it dangles freely one centimeter below pin point, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  blurred_spring: 'wearing pale butter-cream beige Italian linen-silk blend summer suit with soft muted hand and barely-there warm golden-cream tone not white not tan not yellow specific soft butter color slightly warmer than ivory, single-breasted two-button jacket with soft natural unstructured shoulders in relaxed 1970s cut slim notch lapels slightly looser silhouette through body jacket length ending just below hip two flap pockets at hip one welt pocket on left chest all buttons covered in matching butter-cream fabric linen-silk showing natural gentle drape and slight lived-in crease texture at elbows and waist, pistachio-cream silk shirt matching warm ivory tone of bride bodice with barely whisper of green soft and softly greenish-cream casual point collar top two buttons left undone showing hollow of throat no tie no bow tie no pocket square, slim straight-leg trousers in same butter-cream beige linen-silk with clean single front pleat at waistband no side stripe no cuffs slightly cropped ending just above ankle breaking cleanly above shoe no belt waistband clean and minimal, pale dusty sage-green suede loafers slip-on style with no laces no tassels clean minimal almond-toe shape, single hand-embroidered tiny wild fern sprig in pale sage green silk thread approximately 3cm tall on inner-right lapel facing visible only when jacket slightly opens, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  rosewater_ballet: 'wearing deep burnt chocolate brown wool-silk blend three-piece formal suit rich dark chocolate with warm red-brown undertone not cold black-brown not tan sophisticated dark cocoa color deep jewel tone, single-breasted one-button jacket with structured natural shoulders and slim peaked lapels in matching burnt chocolate wool-silk self-faced not satin not shiny jacket length ending just below hip slim tailored fit through body and sleeves one welt pocket on chest two flap pockets at hip level single front button covered in matching chocolate fabric, matching burnt chocolate wool-silk waistcoat vest with five covered buttons down front slim fitted through torso sharp V-neckline showing shirt beneath, soft dusty rose-pink silk shirt matching bride gown color exactly in tone sophisticated muted rose clean point collar top button fastened no tie no bow tie, slim straight-leg trousers in same burnt chocolate brown wool-silk with clean single front pleat no side stripe no cuffs breaking cleanly at ankle, polished dark chocolate brown leather oxford shoes in matching deep brown tone, single small cream freshwater pearl approximately 6mm pinned on left lapel as minimalist boutonniere matching pearls scattered on bride bodice exactly in tone and scale single pearl sitting clean on lapel with no flower no greenery no fabric just one pearl like single dewdrop on chocolate silk, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
};
...
const GLAMOUR_OUTFIT_COUPLE_GROOM: Record<string, string> = {
  ...
  santorini_linen: 'matte bone-white wool-silk double-breasted suit with peaked lapels and six covered bone-white buttons, bone-white silk band-collar shirt buttoned to throat no tie, slim straight-leg bone-white trousers, bone-white suede ankle boots, single clear round-cut crystal boutonniere on left lapel',
  age_of_innocence: 'bone-white silk-wool single-breasted suit with single covered button and notched lapels, bone-white silk mandarin-collar shirt buttoned to throat no tie, slim straight-leg bone-white trousers, bone-white suede oxford shoes, single elongated teardrop cream pearl pinned on left lapel dangling freely',
  blurred_spring: 'pale butter-cream beige Italian linen-silk two-button single-breasted suit with soft natural 1970s shoulders slim notch lapels, pistachio-cream silk shirt with top two buttons open no tie, slim slightly-cropped butter-cream trousers, dusty sage-green suede slip-on loafers, tiny pale sage fern sprig embroidery on inner lapel',
  rosewater_ballet: 'deep burnt chocolate brown wool-silk three-piece suit with single-breasted one-button jacket slim peaked lapels matching chocolate waistcoat with five covered buttons, dusty rose-pink silk shirt with point collar no tie, slim chocolate trousers, polished dark chocolate oxfords, single 6mm cream freshwater pearl on left lapel as minimalist boutonniere',
  nocturnal_animals: 'pure black grain-de-poudre double-breasted tuxedo with satin peaked lapels, black silk collarless shirt buttoned to top, thin black grosgrain ribbon tied at neck, oversized baroque pearl stick pin on left lapel',
};
...
const GLAMOUR_OUTFIT_BRIDE: Record<string, string> = {
  ...
  santorini_linen: 'wearing matte bone-white strapless bustier ball gown in two parts, fitted bustier bodice in matte bone-white silk taffeta with perfectly straight horizontal neckline running cleanly across the upper chest from one shoulder edge to the other no sweetheart curve no dip at center one clean horizontal line, heavily boned with six internal vertical stays creating subtle vertical ridges visible on surface, structured sculptural unadorned matte taffeta, bodice extending to natural waist meeting skirt in clean horizontal seam, dramatically voluminous bell ball skirt built from hundreds of dense knife-sharp vertical pleats in bone-white silk organza each pleat one-centimeter wide pressed crisp and uniform falling in tight parallel vertical lines from waist to floor, pleats multiplying outward as skirt expands into bell silhouette, cathedral-length veil in bone-white silk organza 2.5 meters long attached to back top edge of bustier flowing past both sides of skirt pooling onto floor edges raw and unfinished, single-strand clear crystal rivière necklace with fifteen graduated round-cut clear crystals in diminishing size from center outward set on invisible thread catching light like tiny drops of frozen water, natural elegant makeup with light freckles, pure matte bone-white throughout',
  nocturnal_animals: 'wearing pure black heavy silk duchess satin off-shoulder ball gown with sharp architectural sweetheart neckline cut in angular geometric V, structured boned corset bodice with single diagonal seam from right neckline to left waist set with a line of hand-set jet black Swarovski crystals, massive voluminous bell-shaped ball gown skirt in five cascading tiers of black silk organza over duchess satin base each tier edge finished in raw unrolled frayed cut, cathedral train, Vivienne Westwood three-strand pearl choker with oversized irregular cream white baroque pearls and signature gold orb pendant at center front sitting tight at base of neck, small single cream white pearl stud earrings, scarlet matte red lipstick, natural elegant makeup with light freckles',
  age_of_innocence: 'wearing bone-white silk mikado wedding gown with high-necked bodice in solid opaque matte bone-white silk mikado fitted with clean princess seam tailoring, high symmetric stand collar in matching bone-white silk mikado 2.5 centimeters tall rising cleanly straight up to sit just below the jawline fully enclosing the entire throat, long fitted sleeves in same bone-white silk mikado extending from shoulders all the way down the arms to wrists ending in clean straight cuffs at the wrist bone no buttons no cuff detail, single vertical line of fifteen individual cream freshwater pearls hand-sewn one at a time in perfect alignment directly down exact center front of bodice from base of high collar at hollow of throat straight down to center of natural waistline graduating in size from smallest three millimeters at throat to largest ten millimeters just above waist spaced approximately one and a half centimeters apart, single elongated teardrop-shaped pearl approximately fifteen millimeters long hanging freely from tiny invisible thread below the waistline seam dangling down onto upper skirt, full floor-length A-line skirt in same heavy bone-white silk mikado with soft muted sheen in clean architectural bell-shaped folds no pleats no drape no tiers no decoration, cathedral-length veil in bone-white silk tulle 2.5 meters long attached at back of bodice below high collar flowing past both sides of skirt raw unfinished edges, natural elegant makeup with light freckles',
  blurred_spring: 'wearing tea-length strapless classical ballerina tutu wedding gown in soft bleached green gradient, fitted structured strapless corset bodice in warm ivory-cream silk mikado with clean straight-across horizontal neckline from one shoulder edge to the other no sweetheart curve no dip bodice heavily boned with internal structure creating clean smooth surface extending to exact natural waistline, three delicate tiny sprigs of single wild fern fronds scattered sparsely across the bodice — one fern sprig near the left upper chest, one near the right lower ribcage, one near the center waist — each sprig small and isolated approximately 3cm tall, embroidered in pale sage green silk thread, whisper-soft like pressed botanical specimens, tea-length mid-calf Romantic tutu skirt in classical 1950s Dior New Look bell silhouette where volume at hips is full and rounded extending outward from hips 15-20cm horizontally at widest point then layers fall naturally downward in softly curved bell silhouette NOT flat horizontal NOT a plate profile like rounded tulip or soft bell, constructed from eight layers of soft fine silk tulle stacked in graduated lengths each layer visible as separate frilled edge creating voluminous but naturally hanging multi-layered tulle bell, skirt color very soft bleached sun-faded gradient at waist topmost layers dusty pale sage-cream barely green almost ivory blending with bodice middle layers transition softly to muted pistachio green bottom outermost layers at hem dusty soft moss green muted throughout never saturated never vivid never anime-bright gentle watercolor wash from dusty cream-sage to dusty moss like vintage tulle aged in sunlight, single narrow pale butter-cream silk satin ribbon approximately 2cm wide wraps once around natural waist and ties in small simple knot at exact center back only no ribbon tails no trailing ends no bow at front or side just clean thin ribbon line at waist seam, dusty pale sage green silk satin ballet flats matching hem color clean minimal, hair loose and natural with soft natural waves keeping original front bangs exactly as shown in reference image, no veil no gloves no necklace no earrings no hair accessories no headband no ribbon no flowers in hair natural elegant makeup with light freckles',
  rosewater_ballet: 'wearing dusty rose-pink silk mikado strapless sweetheart ball gown wedding dress with moderate sweetheart neckline gentle M-curve dipping softly at center front approximately 3cm below straight horizontal shoulder line two shoulder edges flat and horizontal center dip soft and rounded not deep V elegant and modest, fitted structured strapless corset bodice in soft dusty rose-pink silk mikado muted warm pink with slight gray undertone not baby pink not hot pink sophisticated vintage rose color like inside of tea rose petal heavily boned internally with clean smooth surface tight fitted through natural waist with clean princess seam tailoring visible as vertical lines shaping torso silk mikado paper-like crispness holding structure, bodice beadwork organic pearl cascade hand-sewn cream freshwater pearls of varying sizes from 2mm to 6mm scattered across bodice surface in soft organic flow pattern concentrated densely along sweetheart neckline edge forming delicate pearl trim then cascading downward across bodice in irregular meandering streams like water drops sliding down silk pearl density highest at neckline gradually thinning as cascade flows toward natural waist pearls individually stitched with no pearl chains no strands hanging no dangling beads all pearls flat against silk surface creating beaded texture not fringe placement asymmetric and natural denser on upper chest thinning as descends like dew beading on petal, from natural waistline grand voluminous ball gown skirt in same dusty rose-pink silk mikado with soft muted sheen not high gloss its weight and structure creating classical full ball gown silhouette extending outward from waist in wide bell shape before cascading to floor length no pleats no tiers no drape no gathering one continuous smooth voluminous princess ball skirt with clean architectural folds cathedral train approximately 1.5 meters behind, delicate dusty rose-pink silk satin ribbon headband 3cm wide tonally matching dress exactly sitting as clean narrow band across top of head like 1950s headband with small tidy flat bow on one side no veil no long ribbon tails no floral crown, keeping original front bangs exactly as shown in reference image only the back and length of hair transforms into black shoulder-length hippie jelly perm wavy hair with soft S-curl waves down both sides of face middle portion and ends only, no gloves no jewelry other than bodice pearls natural elegant makeup with light freckles',
};
...
const GLAMOUR_OUTFIT_COUPLE_BRIDE: Record<string, string> = {
  ...
  in_the_mood: 'pure white silk charmeuse off-shoulder wedding dress, oversized puff sleeves, tiered ball gown skirt',
  summer_film: 'deep navy blue wool sailor-style school uniform with square sailor collar and three white stripes, white inner blouse, crimson red silk ribbon bow, knife-pleated navy skirt above knee, white knee-high socks, Mary Jane shoes',
  lily_choucho: 'muted ash grey wool school blazer with navy crest on chest pocket, white dress shirt, olive green satin ribbon bow tie, dark charcoal-olive tartan check pleated skirt above knee, grey knee-high socks, black penny loafers',
  santorini_linen: 'matte bone-white strapless bustier ball gown with straight horizontal neckline, six vertical bones in bodice, voluminous bell skirt of hundreds of knife-sharp vertical pleats in bone-white silk organza, 2.5 meter cathedral veil flowing past both sides of skirt, single-strand clear crystal rivière necklace with fifteen graduated round crystals at collarbone, natural elegant makeup with light freckles',
  age_of_innocence: 'bone-white silk mikado A-line wedding gown with high 2.5cm stand collar fully enclosing throat and long fitted sleeves to wrists, single vertical line of fifteen graduated cream freshwater pearls hand-sewn down center front from throat to waist ending in single teardrop pearl dangling below waist seam, full bone-white silk mikado A-line skirt in clean architectural bell folds, 2.5 meter bone-white silk tulle cathedral veil, natural elegant makeup with light freckles',
  blurred_spring: 'tea-length strapless classical ballerina tutu wedding gown with warm ivory-cream silk mikado corset bodice with straight horizontal neckline and three tiny wild fern sprigs scattered sparsely across bodice — one upper left chest one lower right ribcage one center waist — each small and isolated 3cm tall embroidered pale sage silk thread whisper-soft pressed botanical specimens, eight-layer soft silk tulle Romantic tutu skirt in sun-faded gradient from dusty pale sage-cream at waist through muted pistachio middle to dusty soft moss green at mid-calf hem classical 1950s bell silhouette, narrow 2cm pale butter-cream silk satin ribbon at waist tied in small knot at center back, dusty pale sage green silk satin ballet flats, hair loose and natural keeping original front bangs exactly no headband no ribbon no hair accessories, natural elegant makeup with light freckles',
  rosewater_ballet: 'dusty rose-pink silk mikado strapless sweetheart ball gown with moderate sweetheart neckline organic cream freshwater pearl beadwork cascading from neckline thinning toward waist fitted structured corset bodice full voluminous princess ball gown skirt with cathedral train approximately 1.5 meters, 3cm narrow dusty rose-pink silk satin ribbon headband with small flat bow on one side, keeping original front bangs exactly only back and length in black hippie jelly perm wavy hair, natural elegant makeup with light freckles',
  nocturnal_animals: 'pure black duchess satin off-shoulder ball gown with angular V sweetheart neckline, diagonal black crystal seam across corset bodice, five-tier voluminous bell skirt of satin and sheer organza with raw frayed edges, three-strand baroque pearl choker with gold orb pendant, scarlet matte red lipstick',
};
...
router.get('/config', (_req, res) => {
  res.json({ pricing: PRICING, fonts: FONTS, subtitleStyles: SUBTITLE_STYLES, selfieConcepts: SELFIE_CONCEPTS.map(c => ({ id: c.id, name: ({ studio_classic: '클래식 스튜디오', studio_gallery: '갤러리 스튜디오', studio_fog: '포그 스튜디오', studio_mocha: '모카 스튜디오', studio_sage: '세이지 스튜디오', outdoor_garden: '가든 웨딩', hanbok_traditional: '전통 한복', hanbok_wonsam: '원삼 혼례', hanbok_dangui: '당의 한복', hanbok_modern: '모던 한복', hanbok_saeguk: '사극풍', hanbok_flower: '꽃 한복', city_night: '시티 나이트', cherry_blossom: '벚꽃', forest_wedding: '숲속 웨딩', castle_garden: '유럽 궁전', cathedral: '성당', watercolor: '수채화', magazine_cover: '매거진 커버', rainy_day: '비 오는 날', vintage_film: '빈티지 필름', cruise_sunset: '크루즈 선셋', cruise_bluesky: '크루즈 블루스카이', vintage_record: '빈티지 레코드', retro_hongkong: '레트로 홍콩', black_swan: '블랙 스완', velvet_rouge: '벨벳 루즈', water_memory: '물의 기억', blue_hour: '블루아워', iphone_mirror: '거울 셀카', rose_garden: '장미 정원', grass_rain: '풀밭', eternal_blue: '블루', heart_editorial: '하이 에디토리얼', vintage_tungsten: '빈티지 텅스텐', aao: '에에올', spring_letter: '봄: 러브레터', summer_rain: '여름: 소나기', autumn_film: '가을: 필름', winter_zhivago: '겨울: 지바고', lovesick: '러브시크', silver_thread: '실버스레드', summer_tape: '서머테이프', rouge_clue: '루즈클루', in_the_mood: '화양연화', summer_film: '썸머필름', lily_choucho: '릴리슈슈', nocturnal_animals: '녹터널 애니멀즈', santorini_linen: '산토리니 리넨', age_of_innocence: '순수의 시대', blurred_spring: '흐릿한 봄', rosewater_ballet: '사랑방다실' } as Record<string, string>)[c.id] || c.id })) });
});
...
function buildSD15DirectPrompt(photoType: string, camera: string, phase: string, sceneIndex: number = 0, conceptId: string = '') {
  const OUTFIT_ANCHORS: Record<string, string> = {
    summer_film: 'Keep the school uniform exactly as shown in the reference image, the gakuran or sailor uniform stays the same',
    lily_choucho: 'Keep the school blazer and skirt or trousers exactly as shown in the reference image',
    hanbok_wonsam: 'Keep the hanbok exactly as shown in the reference image',
    hanbok_dangui: 'Keep the hanbok exactly as shown in the reference image',
    hanbok_modern: 'Keep the hanbok exactly as shown in the reference image',
    hanbok_saeguk: 'Keep the hanbok exactly as shown in the reference image',
    hanbok_flower: 'Keep the hanbok exactly as shown in the reference image',
    hanbok_traditional: 'Keep the hanbok exactly as shown in the reference image',
  };
  const outfitAnchor = OUTFIT_ANCHORS[conceptId] || 'Keep the outfit exactly as shown in the reference image';

  const CAMERA_LOCK = 'Locked-off static tripod shot. Fixed framing held steady throughout. Camera completely still.';

  const groomMotions = [
    'Gentle breeze in the scene, very subtle natural breathing',
    'Soft ambient atmosphere, very subtle natural breathing',
    'Very subtle natural breathing only, almost a still photograph',
    'Gentle breeze in the background, very subtle natural breathing',
  ];

  const brideMotions = [
    'Gentle breeze in the scene, hair strands moving softly in the wind',
    'Soft ambient atmosphere, very subtle natural breathing',
    'Very subtle natural breathing only, almost a still photograph',
    'Dress fabric moving softly in the wind, very subtle natural breathing',
  ];

  const coupleMotions = [
    'Almost a still photograph, very subtle natural breathing',
    'Gentle breeze in the scene, very subtle natural breathing',
  ];
  ...
  return CAMERA_LOCK + ' ' + outfitAnchor + '. ' + list[sceneIndex % list.length];
}
...
async function processVideoAsync(videoId: string, videoEngine: string = 'seedance15') {
  ...
  const rawScenes = (video.scenes as any) || [];
  const firstConceptId: string = (Array.isArray(rawScenes) && rawScenes.length > 0 && typeof rawScenes[0] === 'string') ? rawScenes[0] : '';
  const skipCrop = false;
  console.log('[prewedding-outfit] conceptId=' + firstConceptId + ' skipCrop=' + skipCrop);
  ...
  for (let bi = 0; bi < scenes.length; bi += CLIP_BATCH) {
    ...
    const batchPromises = batchScenes.map((scene, bsi) => {
      ...
      if (videoEngine === 'kling') {
        ...
        const sd15prompt = buildSD15DirectPrompt(scene.photoType, scene.camera, scene.phase, si, firstConceptId);
