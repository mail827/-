...
const GLAMOUR_OUTFIT_GROOM: Record<string, string> = {
  ...
  outdoor_garden: 'wearing navy blue suit with white shirt, floral boutonniere pinned to lapel, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  beach_sunset: 'wearing light beige linen suit with open collar white shirt, barefoot, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  ...
  hanbok_dangui: 'wearing jade-green dopo (Korean scholar overcoat) with traditional V-shaped crossed collar (gyotgit), goreum ribbon ties at chest, yugeon (soft fabric headband), white inner jeogori visible underneath, delicate jade ornament at waist, NOT a western suit NOT a coat, refined traditional Korean scholar groom attire, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  hanbok_modern: 'wearing charcoal gray modern durumagi (Korean traditional long overcoat) with traditional V-shaped crossed collar (gyotgit), goreum ribbon ties at chest, Korean traditional fabric texture, white inner jeogori with mandarin collar visible at neckline, NOT a western suit NOT a blazer NOT a trench coat, contemporary minimalist Korean hanbok groom attire, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  hanbok_saeguk: 'wearing dark navy blue dopo (long traditional Korean overcoat) over white inner robe, traditional V-shaped crossed collar, hair pulled up in traditional Korean topknot with simple black gat hat (wide brimmed Korean traditional hat), subtle gold thread embroidery at hem, dignified composed posture, Korean historical drama nobleman wedding attire, NOT Chinese NOT imperial NOT dragon robe NOT crown, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  hanbok_flower: 'wearing ivory white durumagi (Korean traditional long overcoat) with traditional V-shaped crossed collar (gyotgit), goreum ribbon ties at chest, subtle floral embroidery at hem, soft pastel inner jeogori visible at neckline, small flower accent, NOT a western suit NOT a blazer, gentle spring Korean hanbok groom attire, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  city_night: 'wearing sleek black tuxedo with satin lapels, black bow tie, cufflinks, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  cherry_blossom: 'wearing soft gray suit with light pink boutonniere, white pocket square, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  forest_wedding: 'wearing dark charcoal wool suit with forest green silk tie, simple white boutonniere, polished leather shoes, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  castle_garden: 'wearing classic black formal morning suit with vest, patterned tie, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  cathedral: 'wearing refined charcoal morning suit with ivory vest, patterned silk tie, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  ...
  rainy_day: 'wearing dark navy coat suit, holding umbrella, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  autumn_leaves: 'wearing warm brown tweed suit with earth tones, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
  winter_snow: 'wearing charcoal wool coat suit, winter layers, NOT wearing dress NOT skirt NOT gown NOT feminine clothing',
