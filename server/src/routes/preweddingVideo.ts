...
const SELFIE_CONCEPTS: { id: string; prompt: string; subScenes?: string[] }[] = [
  ...
  { id: 'hanbok_dangui', prompt: 'place this person in warm ondol room with yellow-ochre hanji walls, dark wooden daecheongmaru of traditional hanok, wearing elegant celadon organza dangui over ivory jeogori with plum goreum bow, brass oil lamp warm amber light, intimate refined atmosphere, photorealistic, 8k' },
...
const GLAMOUR_OUTFIT_BRIDE: Record<string, string> = {
  ...
  hanbok_flower: 'wearing deep peony pink silk jeogori with tonal damask petal weave and white inner collar, burgundy wine goreum bow, full ombre organza chima from peony pink to white at hem with chapel train, burgundy wine inner wrist lining, black straight hair with see-through bangs, no floral motifs, romantic Korean bridal attire',
