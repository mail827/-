...
const SELFIE_CONCEPTS: { id: string; prompt: string; subScenes?: string[] }[] = [
  ...
  { id: 'rose_garden', prompt: 'place this person in a lavish rococo-style salon with pale pink walls gilded ornate mirrors and white iron trellis covered in climbing pink roses, crystal chandelier with dripping candle lights above, soft diffused pastel pink light, dreamy hazy atmosphere, photorealistic, 8k', subScenes: ['place this person in a lavish rococo salon with pale pink walls gilded mirrors climbing pink roses, sitting sideways on gilded pink velvet chaise longue with scattered rose petals and macarons on gold tray, soft pastel pink light, photorealistic, 8k', 'place this person on a grand curved marble staircase with wrought iron pink rose vine railing in rococo palace, pale pink walls gilded molding, long dress train cascading down stairs, soft natural window light, photorealistic, 8k', 'place this person standing on a small ornate stone balcony overlooking pink rose garden below, rococo pale pink exterior wall gilded window frame, climbing roses around open French doors, soft overcast afternoon light, photorealistic, 8k', 'place this person standing facing a large gilded mirror in rococo salon, three-quarter back angle with mirror showing face, pale pink walls climbing pink roses around mirror frame, soft diffused pastel pink light, photorealistic, 8k'] },
  { id: 'grass_rain', prompt: 'place this person in a wide green grassy hillside field on an overcast rainy day, tall grass and small wildflowers, mist hanging low, grey sky, muted desaturated green tone, grainy analog film Fuji Superia 400, photorealistic, 8k', subScenes: ['place this person sitting in tall green grass on a hillside, soft overcast diffused light, small bouquet of white wildflowers, muted desaturated green film tone, grainy analog film, photorealistic, 8k', 'place this person walking through a misty green field after rain, mist hanging low over field in distance, everything soft and hazy, slightly damp clothing on shoulders, grainy analog film expired stock, muted washed-out green tones, photorealistic, 8k', 'place this person standing in a wide green field under grey sky looking at misty horizon, fine rain falling around, flat grey overcast light, grainy analog film Kodak Portra 400, muddy green-grey palette, photorealistic, 8k', 'place this person in a green field on grey rainy day, close-up portrait, raindrops on skin, eyes closed soft smile, completely flat grey overcast light, shallow depth of field grassy background dissolved into green blur, grainy analog film Fuji Pro 400H, photorealistic, 8k', 'place this person walking away from camera up a gentle green grassy slope, shot from behind at low waist level, tall grass and wildflowers blurred in foreground, soft overcast light, muted green tone, grainy analog film, photorealistic, 8k'] },
  { id: 'eternal_blue', prompt: 'place this person on an empty grey winter beach at dusk, grey overcast sky blending into grey ocean, wet dark sand, cold wind, edges of frame slightly blurred and darkened as if memory is fading, cool blue-grey desaturated palette, heavy film grain, photorealistic, 8k', subScenes: ['place this person on a frozen lake under heavy grey sky with light snow falling, massive blue tulle skirt spreading across white ice like pool of blue watercolor dissolving into white, monochromatic blue-white-grey palette, quiet melancholic atmosphere, photorealistic, 8k', 'place this person hiding between tall bookshelves in dimly lit old bookstore, warm single desk lamp at end of aisle casting long shadows, dust particles floating in lamplight beam, warm tungsten and cool shadow split, intimate atmosphere, photorealistic, 8k', 'place this person standing alone on empty grey winter beach looking out at ocean, back three-quarters turned to camera, enormous tulle skirt dragging across dark wet sand, distant figure approaching in background, cold desaturated blue-grey monochrome, heavy film grain, photorealistic, 8k', 'place this person in a bedroom where one half is normal with warm lamp light and the other half dissolves into pure white void with objects mid-disappearance, sitting on bed edge facing the void, split warm amber and cold white tone across face, photorealistic, 8k'] },
  { id: 'heart_editorial', prompt: 'place this person in a dark editorial fashion studio with pure black background, hard directional single light source creating deep shadows, high contrast graphic fashion photograph, photorealistic, 8k', subScenes: ['place this person caught mid-stride inside a perfect circle of white spotlight on completely black stage floor, everything outside spotlight is pure black void, hard clean edge between light and dark, shot from slightly above, theatrical lighting, photorealistic, 8k', 'place this person standing back to back with another against white-grey background, dozens of glossy red 3D heart shapes floating and falling around them like rain, flat even studio lighting, red hearts only color in image, editorial fashion, photorealistic, 8k', 'place this person sitting on black cube in dark studio, single hard beauty dish light from directly above casting defined shadows under cheekbones, chin resting on one hand looking directly at camera, everything else pure black, heavy contrast editorial, photorealistic, 8k', 'place this person lying on black floor shot from directly overhead, massive white origami organza train fanned out in perfect spiral around body filling frame like white sculpture on black canvas, hair fanned out around head, looking straight up at camera with intense calm gaze, hard overhead light, photorealistic, 8k'] },
];
