...
const GLAMOUR_OUTFIT_BRIDE: Record<string, string> = {
  ...
  hanbok_dangui: 'wearing pale jade-tinted ivory silk dangui with luminous translucent quality as if light passes through revealing warm ivory glow beneath, open at front with wide flowing sleeves extending past fingertips, deep plum purple silk goreum bow tied elegantly at chest with tails falling past waist, grand full A-line ivory-gold silk chima with soft luminous inner warmth and cathedral train, gold thread calligraphy line embroidery along dangui sleeve edge, black straight hair with see-through bangs tied back with plum silk ribbon, refined elegant traditional Korean bridal attire',
