...
const OUTFIT_BRIDE: Record<string, string> = {
  ...
  hanbok_modern: 'wearing cool dusty blue-grey silk jeogori fitted close to body with traditional curved closure and cropped high waist length, single long deep forest green silk goreum tie with minimal knot and one long tail past waist, full flowing A-line pale cool grey silk organza chima layered over dusty blue-grey silk satin lining creating misty layered depth with graceful sweep train, long sleeves with hidden warm blush pink silk inner wrist lining visible only when hands lift, black straight hair with see-through bangs, no embroidery no gold no pattern, contemporary minimalist Korean bridal attire',
