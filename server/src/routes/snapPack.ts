...
const CONCEPT_MOOD: Record<string, string> = {
  ...
  nocturnal_animals_s1_gallery_groom: 'inside dark penthouse room facing three-story floor-to-ceiling glass wall with back fully turned to camera looking out at vast Seoul night cityscape entire body faces away from camera toward glass, faint ghosted reflection on glass surface showing front of face overlaid on distant city lights, interior pitch black only light source cold blue city glow through glass silhouetting back against night skyline, celluloid grain, 85mm lens rear view only',
  nocturnal_animals_s1_gallery_bride: 'alone looking up at enormous three-meter white marble abstract sculpture inside dark gallery space body angled toward sculpture face tilted up gazing at massive form above, small figure dwarfed by towering white marble stark contrast between matte black silhouette and glowing white marble, hidden uplight behind sculpture base rims edges in cold white face lit only by reflected bounce off marble rest of gallery pitch black, celluloid grain, 50mm lens low angle looking up at both figure and sculpture',
  nocturnal_animals_s1_gallery_couple: 'two figures standing apart in vast minimalist brutalist gallery hall raw concrete walls polished black terrazzo floor six-meter ceiling single enormous abstract monochrome painting on far wall, two meters empty space between them both facing camera perfectly still neither touching, two hard cone ceiling spotlights drop one circle on each rest of hall swallowed in deep black shadow, celluloid grain, 35mm lens eye-level dead-center symmetrical composition',
  nocturnal_animals_s2_intimate_groom: 'alone behind wheel of modern black sedan on night highway both hands gripping steering wheel eyes straight ahead face forward in driver seat unreadable expression lips closed, amber dashboard backlight glowing softly on lower half of face streaks of cold sodium-orange street lamp light slipping across face through windshield in rhythmic flashes, celluloid grain, 35mm lens dashboard-level view from hood of car looking into windshield',
  nocturnal_animals_s2_intimate_bride: 'reflected in bathroom vanity mirror facing mirror directly holding scarlet red lipstick tube up to lower lip with right hand steadying tube with fingertips of left hand retouching lipstick entire image is mirror reflection only, dark black marble bathroom wall behind with brass wall sconce and black stone countertop, single cold white LED strip above mirror casting flat clinical light from above every pore sharply visible shadows minimal under jaw, celluloid grain, 85mm lens tight chest-up frontal mirror reflection',
  nocturnal_animals_s2_intimate_couple: 'two figures seated in two deep emerald green velvet mid-century armchairs facing each other in modernist living room two meters apart with low black marble coffee table between holding two wine glasses one half full one empty, both seated in profile looking at each other without speaking hands resting on armrests, black brass floor lamp with amber tungsten globe bulb behind each chair lights only one side of each face in warm glow space between falls into cooler shadow, celluloid grain, 50mm lens side profile two-shot at seated eye level',
  nocturnal_animals_s3_nocturne_groom: 'standing alone at exact center of vast minimalist brutalist gallery hall raw concrete walls polished black terrazzo floor single enormous abstract monochrome painting on far wall, single figure dead center of frame facing camera perfectly still arms at sides motionless, one large circular ceiling cone spotlight drops single pool of light encompassing entire body rest of hall swallowed in deep black shadow, celluloid grain, 35mm lens eye-level dead-center symmetrical composition',
  nocturnal_animals_s3_nocturne_bride: 'overhead bird-eye view standing at edge of outdoor infinity pool at night looking down into pitch black pool water that mirrors night sky, full skirt spread across dark wet tile around feet, single drop of scarlet red lipstick has fallen onto black water surface below slowly blooming outward into red ink-cloud in otherwise pitch black pool, cold UV blue underwater lights inside pool render everything deep navy-black only color note in frame is red bloom silhouette of modernist concrete villa behind against starless night sky, celluloid grain, 35mm lens overhead bird-eye top-down view',
  nocturnal_animals_s3_nocturne_couple: 'two figures sitting at corner table in deep emerald green-walled fine dining restaurant at closing time all other tables empty and dark, both leaning slightly forward looking directly into each others eyes for the first time two half-full red wine glasses between them on white linen rim of her wine glass marked with vivid scarlet lipstick imprint, single warm brass pendant lamp directly above table drops amber spotlight only on them and wine glasses rest of emerald room falls into deep green-black shadow, celluloid grain, 50mm lens diagonal two-shot at seated eye level',

  santorini_linen_s1_wall_groom: 'standing alone in profile at edge of white limestone cliff overlooking Mediterranean sea wind blowing hair forward body turned sideways to camera gaze directed out at sea not at camera, late afternoon sun angled lower from right still bright but warming long soft shadow cast across white cliff stone toward camera sea and sky still blown-out with faint warm tone at horizon, celluloid grain, 50mm lens at hip height from behind and slightly to side',
  santorini_linen_s1_wall_bride: 'standing alone facing camera at base of massive sunlit white limestone wall of Italian cliff village body centered frontal perfectly still arms at sides, ten-meter lime-washed wall behind with deep inset rectangular window shadows punched into wall like black holes, extreme overexposed Mediterranean noon sun directly overhead blasting wall into blown-out highlights her figure merging with the blown-out white wall only black hair breaking whiteness heat haze rising from stone, celluloid grain halation bloom, 35mm lens eye-level frontal composition',
  santorini_linen_s1_wall_couple: 'two figures standing together shoulder to shoulder against massive sunlit white limestone wall of Italian cliff-top village ten meters high in bleached lime-washed stone with deep inset rectangular window shadows, both facing camera perfectly still neither touching, extreme overexposed Mediterranean noon sun blasting wall into blown-out white only their black hair and hollow windows and razor-sharp shadows under feet breaking whiteness, celluloid grain halation bloom, 35mm lens eye-level dead-center symmetrical composition',
  santorini_linen_s2_alley_groom: 'standing alone inside empty whitewashed Mediterranean room facing single tall arched window open to sea beyond body silhouetted in doorway window frame backlighting him completely into dark silhouette, blinding white Mediterranean light pouring through arched window bleaching far wall into pure white interior room walls closest to window blown-out white walls nearest to camera falling into soft dim shadow heat haze shimmer at window opening, celluloid grain halation bloom around window, 35mm lens eye-level profile shot',
  santorini_linen_s2_alley_bride: 'walking alone through narrow sunlit alley between two towering white limestone walls of Italian cliff village barely two meters wide captured mid-stride from three-quarter back angle body turned slightly so right shoulder and profile of face visible not looking at camera, veil trailing two meters behind across pale stone pavement arms hanging naturally at sides, overhead sun blasting walls into pure blown-out white far end of alley glowing white rectangle as if alley ends in pure light with no horizon visible heat haze in alley air, celluloid grain halation bloom, 50mm lens shot from three-quarter back at chest height',
  santorini_linen_s2_alley_couple: 'two figures passing each other beneath massive Romanesque white stone archway set into thick white cliff-village wall five meters tall two meters deep creating tunnel of shadow, she walks out toward bright sunlit exterior he walks in from sunlit exterior toward camera-side shadow captured at exact moment of crossing mid-arch neither turning to look both look forward in direction they are walking, inside arch tunnel deep cool shadow beyond arch on either end blown-out blasted white light bleeding inward toward center they meet exactly at darkest center point, celluloid grain, 35mm lens shot at eye level from inside arch looking down its length',
  santorini_linen_s3_cliff_groom: 'standing alone at top of narrow outdoor white limestone staircase cut into cliff-side village wall looking down staircase body angled slightly forward one hand resting lightly on white stone wall gaze directed down at steps below, staircase walls on either side blasted white by overhead sun razor-sharp diagonal shadow-and-light bands on steps worn stone staircase rising steeply narrow space only one person fits at a time, celluloid grain, 50mm lens shot from street level at base of staircase looking up',
  santorini_linen_s3_cliff_bride: 'standing alone on small white stone terrace at edge of Italian cliff-top village leaning hip lightly against white stone balustrade body turned three-quarters to camera gaze directed outward toward sea not at camera, veil and fabric catching hot dry wind coming off sea veil lifting and billowing horizontally to her right, extreme peak noon sun from directly above the sea and sky behind blown completely white with no detail horizon line completely dissolved white balustrade and white garments merging into blown background only silhouetted profile and black hair reading as dark shapes against pure white, celluloid grain halation bloom with heat haze shimmer, 50mm lens side profile at chest height',
  santorini_linen_s3_cliff_couple: 'two figures standing together at very edge of white limestone cliff-top overlooking Mediterranean at late golden hour hands clasped fingers interlaced between them both facing outward toward vast sea horizon below, warm low golden sun from camera-right bathes them from behind casting long soft shadows toward camera sea and sky soft gradient of pale honey-gold at horizon fading through apricot to lavender above cliff stone beneath feet glowing amber bone-white garments now tinted warm rose-gold, celluloid grain, 24mm wide lens shot from slightly behind at shoulder height looking out toward horizon',

  age_of_innocence_s1_stairs_groom: 'standing alone halfway up grand curved marble staircase inside 1880s Metropolitan Opera House lobby white Carrara marble steps with dark mahogany bannister curving behind body one step from top in mid-stride one hand resting lightly on mahogany bannister body angled three-quarter to camera looking up toward top of stairs not down head tilted slightly face calm and composed eyes focused with quiet intent on something above, massive crystal chandelier visible above glowing in warm gaslight gilded mirror on far wall reflecting distant figures in evening dress as blurred spots of light and black silhouettes marble glowing honey-gold warm amber gaslight from chandelier bathing from overhead casting soft downward shadows, celluloid grain, 35mm lens low angle from base of staircase looking up past him toward ceiling chandelier',
  age_of_innocence_s1_stairs_bride: 'alone high up on rolling wooden library ladder in two-story Gilded Age private library standing on fifth rung reaching up with right hand to slide leather-bound book partway out of tall mahogany bookshelf face in three-quarter profile looking at book spine not at camera, endless floor-to-ceiling bookshelves filled with leather-bound volumes in dark forest green and oxblood bindings behind her brass ladder rail curving along shelves full skirt cascading down ladder rungs veil trailing down to floor below, warm afternoon sunlight pours in from unseen tall window camera-right casting sharp diagonal beam across library dust motes hitting gown and books in warm amber deep cool shadow on opposite side of room, celluloid grain, 35mm lens low angle from library floor looking up at her on ladder',
  age_of_innocence_s1_stairs_couple: 'two figures at exact moment of passing each other on cobblestone street outside Gilded Age townhouse at dusk she descending from waiting black horse-drawn carriage with liveried coachman holding door he walking up townhouse stone entry steps from opposite direction, they cross paths in narrow space between carriage and stairs she captured mid-step down from carriage footboard one hand lifted holding skirt slightly he captured mid-step up stone stairs one hand on iron railing their bodies pass within arm length but neither turns head both look forward in direction they are walking, blue-grey dusk sky overhead single gas streetlamp casts warm amber pool on wet cobblestones between them carriage and townhouse in cool shadow, celluloid grain, 35mm lens shot from across street at eye level carriage on right stairs on left both figures captured mid-motion in middle',
  age_of_innocence_s2_opera_box_groom: 'standing alone in Gilded Age private study before large marble fireplace with orange flame burning low mahogany panelled walls lined with leather-bound books behind deep forest green leather wing chair in soft focus to right, body in three-quarter profile facing fire right hand resting on marble mantelpiece holding folded ivory letter card hanging loosely between fingers over flame but not yet dropping it face lit from below by amber firelight expression not tormented only still and resigned, letter still intact pristine white flame licking upward toward its edge but not yet touching firelight amber-orange on front of figure rest of study falling into deep cool shadow behind, celluloid grain, 50mm lens medium shot from fireplace side at standing eye level',
  age_of_innocence_s2_opera_box_bride: 'alone in private opera box shown in strict side profile to camera head turned fully to left so camera sees only left side of face from ear to nose tip right eye not visible, holding mother-of-pearl opera glass up to right eye with both gloved hands but opera glass angled sharply sideways pointed to her far left across opera house toward opposite box not toward stage below watching someone across theater through opera glass caught in private act of observation lips softly parted in focused concentration, warm amber gaslight from distant crystal chandelier glows out of focus behind upper-left crimson velvet box wall fills background in deep red shadow face lit by soft amber bounce from opera house interior, celluloid grain, 85mm lens tight side-profile portrait from her left',
  age_of_innocence_s2_opera_box_couple: 'two figures seated in private velvet-lined opera box overlooking vast 1880s Gilded Age opera house deep crimson velvet upholstered chairs dark mahogany box railing gas-lit crystal chandelier glowing far in distance beyond box, holding single long-stemmed yellow rose resting across her lap, they sit shoulder to shoulder in box but both face forward out toward opera stage below neither looks at other his face in three-quarter profile to camera her face in three-quarter profile on opposite side small deliberate gap of velvet armrest visible between them, warm amber gaslight from distant chandelier washes them from front deep velvet shadow behind them in box bone-white garments glowing against crimson velvet interior, celluloid grain, 50mm lens shot from rear of opera box at seated eye level looking past them toward stage',
  age_of_innocence_s3_study_groom: 'seated alone at Gilded Age mahogany writing desk in private study body angled slightly toward desk surface face in profile looking down at desk objects in front with still concentration lips closed, on desk single long-stemmed yellow rose lying diagonally across polished surface silver dip pen resting beside opened glass inkwell with dark blue-black ink folded ivory letter card lying half-tucked under rose with corner of handwriting visible right hand holds silver pen poised above letter card as if about to write or about to stop pen suspended mid-air not yet touching paper left hand rests flat on desk beside rose, single tungsten reading lamp on desk casts warm amber pool of light across desk surface and up onto face from below face half-lit amber and half in soft shadow mahogany-panelled study walls behind falling into deep cool darkness, celluloid grain, 50mm lens medium shot from right side at seated eye level showing him and full desk in frame',
  age_of_innocence_s3_study_bride: 'seated alone at small round walnut side table in dimly lit Gilded Age drawing room sits in three-quarter profile to camera at small table gaze directed down at table surface with quiet focus lips softly parted, both hands completely bare no gloves two long bone-white silk opera-length gloves already removed lie empty and flat on walnut table surface beside right hand crumpled softly like shed skins both glove fingers pointing away from body bare right hand extended forward fingertips just touching petals of single long-stemmed yellow rose lying across walnut table rose head turned toward bare hand bare left hand rests on lap, single tungsten reading lamp on table to right casts warm amber light upward onto face and hands and rose walnut table glowing honey rose saturated yellow in pool of lamplight drawing room behind falling into deep soft-focus mahogany shadow, celluloid grain, 85mm lens three-quarter portrait from her left at seated chest height',
  age_of_innocence_s3_study_couple: 'two figures seated in exact same private velvet-lined opera box as opening same deep crimson velvet upholstered chairs same dark mahogany railing same gas-lit crystal chandelier glowing far in distance, same position as opening both facing forward toward opera stage below both in three-quarter profile to camera but now single long-stemmed yellow rose that she held in opening has been transferred pinned at his left lapel just above teardrop pearl fully bloomed yellow rose against bone-white lapel her right hand closest to him rests on velvet armrest between them his left hand rests on same armrest their little fingers just barely touching along armrest edge detail almost invisible unless looked for neither looks at other both still face stage, opera chandelier light casts same warm amber glow as opening crimson velvet glowing same way composition identical to opening, celluloid grain, 50mm lens shot from rear of opera box at seated eye level identical to opening',

  blurred_spring_s1_porch_groom: 'standing beside faded red Schwinn-style bicycle in front of 1970s suburban detached garage with peeling white paint and faded green trim, one hand on handlebar gaze directed down at Polaroid photograph resting in wicker front basket among loose white flowers small private half-smile body angled toward bicycle, warm late-morning sun from camera-left washes white garage wall in blown-out bleached cream halation bloom on white wall, Kodak Gold 200 celluloid grain, 50mm lens',
  blurred_spring_s1_porch_bride: 'standing barefoot on sunlit backyard lawn of 1970s suburban house face in three-quarter profile looking down at own bare feet on cool grass lips softly parted one foot slightly pointed in instinctive ballet fifth position from memory, dusty sage green silk satin ballet flats lie discarded on grass two meters behind clearly visible faded red Schwinn-style bicycle leans against white picket fence in soft-focus background, warm mid-morning sun from upper-right halation bloom around bodice edges shadow short and soft in bright grass, Kodak Gold 200 celluloid grain sun-bleached pastel palette warm amber cast, 85mm lens',
  blurred_spring_s1_porch_couple: 'two figures standing together on wooden back porch of 1970s American suburban clapboard house white wood siding with faded green shutters behind screen door with metal mesh slightly ajar framing them on right side backyard grass extending behind to white picket fence, she holding freshly-taken Polaroid photograph in right hand at hip height still developing and slightly hazy both facing outward from porch toward backyard not looking at each other neither posing she in three-quarter angle slightly behind him, soft warm morning sunlight from right filters through tall oak tree leaves overhead casting dappled gold patterns across porch floorboards and hem of skirt, Kodak Gold 200 celluloid grain warm halation bloom on white porch edges, 50mm lens',
  blurred_spring_s2_sprinkler_groom: 'squatting low on sunlit suburban backyard lawn with both feet flat on grass and knees bent deep body compact and low in relaxed casual crouch not kneeling, holding Polaroid photograph in both hands in front of chest turning it to own face gaze down at Polaroid soft private half-smile face three-quarter to camera with eyes and nose visible not obscured by hair, faded red Schwinn bicycle lying on grass two meters behind clearly visible white picket fence and clapboard house behind, peak noon sun overhead washes scene in blown-out warm white-gold grass pale bleached chartreuse, Kodak Gold 200 celluloid grain halation bloom on white fence overexposed, 50mm lens',
  blurred_spring_s2_sprinkler_bride: 'sitting on interior wooden window bench with knees folded up and tutu skirt spread around legs body turned toward open window in three-quarter profile forehead resting lightly against wooden window frame looking out at sunlit backyard beyond bare feet curled beneath, white lace curtains with delicate floral pattern billow gently around her lifted by summer breeze curtain edges catching bright backlight dissolving into overexposed white, extreme blown-out noon sunlight outside window creates halo of pure white light around silhouette room interior behind in soft warm honey shadow glimpse of flowered wallpaper face lit by backlit window glow delicate rim light on hair and shoulder, Kodak Gold 200 celluloid grain strong halation bloom around entire silhouette where backlight meets edges window light dissolving into pure white overexposed by two stops, 85mm lens',
  blurred_spring_s2_sprinkler_couple: 'two figures captured mid-motion running through rotating oscillating garden sprinkler on sunlit backyard lawn of 1970s suburban house water arcs spraying in bright diagonal lines creating small rainbow in air between them and sun, both laughing mid-run she a half-step ahead of him he behind her not reaching for her but caught in same arc of movement both faces angled toward sun-sparkled water droplets not at camera she mid-laugh he mid-grin hair wet and clinging to forehead clothes visibly damp barefoot on wet grass, water droplets catching extreme overhead noon sun create thousands of tiny bright spots like scattered diamonds around them, Kodak Gold 200 celluloid grain strong halation bloom on every water droplet soft motion blur on water arcs sharp on faces bleached sun-soaked palette overexposed, 35mm lens',
  blurred_spring_s3_twilight_groom: 'seated in deep brown leather wingback chair in corner of 1970s suburban den at dusk jacket off and draped on chair arm shirt rumpled and untucked, single amber table lamp with fringed shade casts warm tungsten pool on face and hands holding large hardcover book open on lap carefully sliding Polaroid photograph between two pages with right hand looking down at book with quiet finality lips closed, dark wood panelled walls with framed family photographs in shadow small window above showing deep blue-violet evening sky warm amber tungsten on right side of face deep cool blue evening shadow on left, Kodak Gold 200 celluloid grain warm amber and cool blue contrast halation bloom around lamp, 85mm lens',
  blurred_spring_s3_twilight_bride: 'standing in center of 1970s suburban backyard lawn at magic hour barefoot on cooling grass face tilted up toward sky watching changing evening light eyes half-closed lips softly parted arms hanging naturally at sides, dusty sage ballet flats still discarded elsewhere on lawn white picket fence and clapboard suburban house silhouetted behind against deep rose-magenta fading to lavender fading to pale peach twilight sky first fireflies tiny specks of warm glow visible above lawn, warm golden-magenta magic hour sun just above horizon casts long soft pink shadows across lawn reaching toward camera entire figure bathed in warm rose-amber light hair loose and slightly blown by evening breeze, Kodak Gold 200 celluloid grain warm rose-gold cast first firefly glows visible halation bloom softening horizon line, 50mm lens',
  blurred_spring_s3_twilight_couple: 'two figures standing together on same wooden back porch of 1970s American suburban clapboard house same white wood siding same faded green shutters same screen door same backyard extending to white picket fence, both facing outward from porch toward backyard same position as opening but now his right hand is clasped with her left hand between them with fingers interlaced and in his other hand he holds open hardcover book with Polaroid photograph visible between pages their pose in new reality mirroring exactly pose in Polaroid photograph, magic hour deep rose-gold evening light has replaced morning gold sky behind backyard glowing pink-lavender first fireflies beginning to glow, Kodak Gold 200 celluloid grain halation bloom on porch edges warm rose-gold cast, 50mm lens',

  rosewater_ballet_s1_orchard_groom: 'seated in deep wingback armchair upholstered in dusty green velvet placed beside stone fireplace in New England 1860s living room in three-quarter profile to camera facing fire one leg crossed over the other open leather-bound book resting on crossed knee right hand holding book left page flat face in profile looking down at pages with deep attention lips softly closed, on small round wooden side table beside armchair rests cream manuscript page placed carefully flat edges slightly ink-stained, crackling orange fire flames in stone fireplace cast warm flickering light on right side of face and book pages manuscript page glowing in firelight soft cool blue-lavender evening light from window behind balancing warm fire glow preventing heavy amber cast rest of room in gentle rose-mauve shadow, Tiffen Rose FX Kodak VISION3 500T celluloid grain, 85mm lens',
  rosewater_ballet_s1_orchard_bride: 'seated at small wooden writing desk in sloped-ceiling attic writing room of New England wooden house body in three-quarter profile to camera leaning forward over desk writing with quill pen on sheet of cream paper full attention on writing not at camera, scattered across desk glass inkwell with dark brown-black ink stack of cream manuscript pages with handwriting in elegant copperplate script second quill pen small brass oil lamp turned off, soft cool-warm balanced morning light from sloped attic window pours down diagonally onto hair and shoulder and manuscript pages creating gentle peachy-cream beam filled with visible floating dust motes rest of attic in soft rose-cream shadow of sloped wooden beams never heavy amber, Tiffen Classic Soft and Rose FX Kodak VISION3 500T celluloid grain, 85mm lens',
  rosewater_ballet_s1_orchard_couple: 'two figures inside Orchard House-style 1860s New England wooden living room in early morning warm wooden floor planks soft cream wallpaper with faint floral pattern lace curtains at tall windows, she standing across room near tall window beside small wooden writing table back half-turned to him right hand placing single loose cream manuscript page on top of table among other papers small glass inkwell and quill pen visible he seated in dusty green velvet wingback armchair by stone fireplace reading open leather-bound book head tilted down toward pages, neither looks at the other both absorbed in own morning activity in same shared room, cool morning daylight with soft peachy undertone pours through lace curtains casting gentle dappled patterns across wooden floor fireplace behind him with small flames adding gentle warm glow on one side balancing cool window light mixed cool-warm rose-cream atmosphere, Tiffen Classic Soft and Rose FX Kodak VISION3 500T celluloid grain, 35mm lens eye-level wide shot',
  rosewater_ballet_s2_shore_groom: 'standing in center of small wildflower garden with tall grasses and white daisies beside white clapboard New England house in three-quarter angle to camera having just bent down to pick up single cream manuscript page that has blown out of house and landed among flowers right hand holding paper up to chest height to read face looking down at paper with quiet curiosity eyebrows slightly raised in soft surprise and interest lips slightly parted, white clapboard house in soft focus with climbing pink roses tall oak branches overhead creating dappled patterns, peak early afternoon cool-warm balanced sunlight filtered through oak leaves creates moving dappled cream-peach patches across suit and cream paper climbing roses on wall providing pink color echo, Tiffen Rose FX Kodak VISION3 500T celluloid grain, 85mm lens',
  rosewater_ballet_s2_shore_bride: 'walking barefoot along edge of calm Atlantic shore of New England rocky coast captured mid-stride walking slowly toward water edge where small foam waves reach wet sand body in three-quarter back angle to camera right foot stepping onto damp sand left foot trailing in drier sand behind dusty sage-cream ballet slippers abandoned in sand two meters behind clearly visible face in profile turned slightly toward horizon looking at sea with quiet joy lips softly parted, holding up full skirt with both hands lifted slightly at sides to keep it away from wet sand exposing bare ankles and feet hair softly blown by sea breeze, calm flat sea stretches to horizon behind with small white foam waves large gray granite boulders at far right of shoreline distant rocky New England coastline silhouette few seagulls in sky, late afternoon golden hour sun from camera-right at low angle gentle long shadows sky glowing in soft dusty rose-peach gradient with pale lavender-blue at horizon pink tones harmonizing with sky no yellow amber, Tiffen Rose FX Kodak VISION3 500T celluloid grain, 50mm lens',
  rosewater_ballet_s2_shore_couple: 'two figures at New England rocky coastal beach picnic in late afternoon seated on red-and-white gingham picnic blanket spread across smooth sand and small flat granite rocks at edge of shore small waves lapping gently in soft focus behind wicker picnic basket open with corner of white linen cloth visible two glass bottles of lemonade with condensation beading open book of poetry face-down on blanket small jar of wild beach roses on blanket between them rests cream manuscript page its corner held down by small smooth beach stone, she sitting with legs folded sideways beneath full skirt which pools across blanket in voluminous folds body turned slightly toward sea face in three-quarter profile looking out at water with soft contentment he sits about one meter from her on same blanket cross-legged with jacket off folded neatly beside him sleeves rolled up slightly showing forearms face in three-quarter profile looking toward her but not intensely small comfortable half-smile hand resting on blanket near but not touching manuscript neither performs romance both occupy own comfortable presence in shared space, late afternoon golden hour light filtered soft through rose-peach sky sea shimmering pink-silver behind harmonizing with dusty rose gown, Tiffen Rose FX Kodak VISION3 500T celluloid grain, 50mm lens',
  rosewater_ballet_s3_attic_groom: 'standing outside wooden front door of white clapboard New England 1860s house on stone front step in three-quarter profile to camera one hand reaching toward small wooden mailbox mounted beside door placing folded cream letter into mailbox other hand at side gaze directed at mailbox with quiet focus lips softly closed, white painted wooden door with brass knocker behind small glass panes revealing soft interior shadow climbing ivy partially on clapboard wall, soft peachy-cream late morning light from camera-right white house wall catching gentle pink daylight reflection no heavy amber cast, Tiffen Classic Soft and Rose FX Kodak VISION3 500T celluloid grain, 50mm lens',
  rosewater_ballet_s3_attic_bride: 'shown from behind standing at tall wooden-framed window of New England 1860s house visible from behind hair cascading down bare back and shoulders in soft waves narrow satin headband with small side bow visible at top of head standing facing window with forehead almost touching cold glass right hand resting flat on glass at shoulder height left hanging at side, outside window soft snow falls in gentle white flakes across dim New England winter yard dusk light pale dusty blue-lavender with rose-peach undertones at horizon where last daylight lingers single naked oak tree black silhouette wooden fence dusted in white snow, back of bodice visible with fifteen covered buttons running down center back spine from upper back to natural waist full skirt cascading down behind onto Persian rug patterned in dusty rose and cream cathedral train pooling, room interior dim lit only by single oil lamp on small side table casting soft warm tungsten glow with rose-cream tones blending with cool blue-lavender snowfall light from window balanced mix of warm interior and cool exterior no heavy yellow amber, Tiffen Rose FX Kodak VISION3 500T celluloid grain, 50mm lens',
  rosewater_ballet_s3_attic_couple: 'two figures inside same Orchard House-style 1860s New England wooden living room from opening same warm wooden floor same soft cream wallpaper same lace curtains at tall windows same stone fireplace, same positions as opening she near writing table he seated in fireplace armchair but now ribbon-bound manuscript stack held between them she standing close beside his armchair having just brought manuscript to him both of her hands holding bottom edge of bound manuscript his right hand lifting from armchair to grasp top edge their hands meeting on shared manuscript with her fingers and his fingers just touching at side of paper stack fingertip-to-fingertip meeting through shared object both of them look down at manuscript together in their shared grip not at each other both with quiet contented half-smiles, evening magic hour rose-peach light pours through lace curtains replacing morning light of opening room bathed in deeper rose-peach tones with fireplace orange glow adding gentle warm accent all tones harmonizing in rose-cream-peach palette without yellow amber heaviness, Tiffen Rose FX Kodak VISION3 500T celluloid grain, 35mm lens eye-level wide shot',
};
