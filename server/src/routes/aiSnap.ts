...
const SOLO_PROMPTS: Record<string, { groom: string; bride: string }> = {
  ...
  watercolor: {
    groom: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same person in a fine art wedding portrait, cream linen suit, painterly soft focus floral background, diffused golden light, Vogue editorial aesthetic, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
    bride: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same person in a fine art bridal portrait, flowing soft tulle gown, painterly muted pastel floral background, diffused golden light, Vogue editorial aesthetic, ethereal dreamy, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  },
  magazine_cover: {
    groom: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same person in a high fashion magazine cover portrait, designer black suit, clean studio backdrop, single dramatic spotlight, strong editorial pose, GQ cover aesthetic, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
    bride: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same person in a high fashion bridal magazine cover, haute couture white gown, clean minimalist backdrop, dramatic single light source, confident elegant pose, Vogue cover aesthetic, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  },
  rainy_day: {
  ...
  autumn_leaves: {
    ...
    bride: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same person in an autumn bridal portrait, ivory dress, surrounded by golden red maple leaves, fall foliage canopy, warm amber golden hour light, romantic cozy, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  },
  winter_snow: {
    groom: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same person in a winter wedding portrait, charcoal wool coat suit, gentle snowfall, frosted trees, soft blue-white light, serene winter atmosphere, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  ...
  vintage_film: {
    groom: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same person in a vintage film wedding portrait, retro brown suit, warm Kodak Portra 400 tones, soft film grain, natural window light, 1970s nostalgic aesthetic, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
...
const COUPLE_PROMPTS: Record<string, string> = {
  ...
  castle_garden: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same couple in a dramatic European castle wedding, the man in classic black tailcoat on the left, the woman in grand white ball gown with cathedral train on the right, baroque palace with ornate columns and chandeliers, dramatic golden light streaming through tall windows, cinematic grandeur, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  cathedral: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same couple in a romantic cathedral wedding ceremony, the man in charcoal morning suit on the left, the woman in classic ivory cathedral gown with long veil on the right, warm candlelight illuminating gothic arches, stained glass casting colorful light, white roses lining the aisle, intimate romantic atmosphere, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  watercolor: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same couple in a fine art wedding portrait, the man in cream linen suit on the left, the woman in flowing soft tulle gown on the right, painterly soft focus background with muted pastel florals, diffused golden light, Vogue editorial aesthetic, dreamy romantic atmosphere, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  magazine_cover: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same couple in a high fashion wedding magazine cover shoot, the man in designer black suit with perfect fit on the left, the woman in haute couture white gown on the right, clean minimalist studio with single dramatic spotlight, strong confident poses, Vogue Korea cover aesthetic, high contrast editorial lighting, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  rainy_day: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same couple sharing a transparent umbrella in gentle rain, the man in dark navy coat suit on the left, the woman in white dress on the right, soft rain creating beautiful bokeh, wet cobblestone street reflections, intimate romantic mood, soft diffused overcast light, cinematic rain photography, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  autumn_leaves: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same couple in an autumn wedding scene, the man in warm brown tweed suit on the left, the woman in ivory dress on the right, surrounded by golden red maple leaves, tree-lined avenue with fall foliage canopy, warm amber golden hour light, romantic cozy autumn atmosphere, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
  winter_snow: 'keep the exact same face, facial features, face shape, eyes, nose, lips unchanged. place the same couple in a winter wonderland wedding, the man in charcoal wool coat suit on the left, the woman in white fur-trimmed gown on the right, gentle snowfall, frosted pine trees, soft blue-white winter light, breath visible in cold air, magical serene winter romance, preserve original facial identity exactly, do not alter or beautify the face, photorealistic, 8k',
