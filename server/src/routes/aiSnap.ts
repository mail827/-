...
const SOLO_PROMPTS: Record<string, { groom: string; bride: string }> = {
  ...
  hanbok_dangui: {
    ...
    bride: 'place the same person in warm ondol room with yellow-ochre hanji walls, brass oil lamp on low wooden table, wearing pale jade-tinted ivory silk dangui with luminous translucent celadon glow and wide flowing sleeves, deep plum goreum bow at chest, ivory-gold silk chima with soft inner warmth spread in perfect circle on hanji floor, gold calligraphy embroidery on dangui sleeve edge catching lamplight, black straight hair with plum silk ribbon, warm amber light, photorealistic, 8k, no Japanese kimono, no Chinese hanfu, no western suit, no blazer, no trench coat, no modern overcoat, accurate Korean hanbok structure, correct collar direction',
  },
  hanbok_modern: {
