...
const SOLO_PROMPTS: Record<string, { groom: string; bride: string }> = {
  ...
  outdoor_garden: {
    groom: 'place the same person in an outdoor garden wedding setting, wearing navy blue suit with boutonniere, lush botanical garden background with blooming flowers, golden hour sunlight filtering through trees, natural romantic atmosphere, photorealistic, 8k',
    bride: 'place the same person in an outdoor garden bridal setting, wearing flowing white wedding dress, surrounded by blooming roses and wisteria, golden hour sunlight, holding wildflower bouquet, ethereal natural beauty, photorealistic, 8k',
  },
  beach_sunset: {
    groom: 'place the same person in a beach wedding setting at golden sunset, wearing light linen suit, warm orange pink sky, pristine white sand beach, gentle sea breeze, relaxed confident pose, photorealistic, 8k',
    bride: 'place the same person in a beach bridal setting at golden sunset, wearing flowing white dress, warm orange pink sky reflecting on ocean, barefoot on white sand, windswept hair, romantic atmosphere, photorealistic, 8k',
  },
  hanbok_traditional: {
  ...
  cherry_blossom: {
    groom: 'place the same person in a cherry blossom wedding setting, wearing gray suit with pink boutonniere, surrounded by pink sakura petals falling, spring sunlight filtering through blossom canopy, dreamy pastel atmosphere, photorealistic, 8k',
    bride: 'place the same person in a cherry blossom bridal setting, wearing soft white dress, surrounded by clouds of pink sakura petals, spring sunlight, ethereal pastel pink atmosphere, romantic and magical, photorealistic, 8k',
  },
  forest_wedding: {
  ...
  castle_garden: {
    groom: 'place the same person in a fairytale castle wedding setting, wearing classic black formal suit with bow tie, magnificent European stone castle with towers in background, grand garden with fountain and hedge maze, warm golden hour lighting, dreamy cinematic atmosphere like a movie scene, photorealistic, 8k',
    bride: 'place the same person in a fairytale castle bridal setting, wearing magnificent white ball gown with long train, European stone castle with towers in background, grand garden with fountain, warm golden hour lighting, princess-like dreamy cinematic atmosphere, photorealistic, 8k',
  },
  cathedral: {
    groom: 'place the same person in an elegant European cathedral wedding setting, wearing refined charcoal morning suit with vest and patterned tie, gothic stone cathedral with stained glass windows and candlelight, classic white flower arrangement, old world romantic elegance, soft warm lighting, photorealistic, 8k',
    bride: 'place the same person in an elegant European cathedral bridal setting, wearing classic white cathedral-length wedding gown with veil, gothic stone cathedral with stained glass windows and candlelight, white flower arrangement, old world romantic elegance, soft warm lighting, photorealistic, 8k',
  },
  watercolor: {
  ...
  rainy_day: {
    groom: 'place the same person in a romantic rainy day portrait, dark navy coat suit, holding umbrella, gentle rain with bokeh, wet street reflections, cinematic mood, photorealistic, 8k',
    bride: 'place the same person in a romantic rainy day bridal portrait, white dress, transparent umbrella, gentle rain creating soft bokeh, wet cobblestone reflections, intimate cinematic mood, photorealistic, 8k',
  },
  autumn_leaves: {
    groom: 'place the same person in an autumn wedding portrait, warm brown tweed suit, golden red maple leaves falling, tree-lined path, warm amber light, photorealistic, 8k',
    bride: 'place the same person in an autumn bridal portrait, ivory dress, surrounded by golden red maple leaves, fall foliage canopy, warm amber golden hour light, romantic cozy, photorealistic, 8k',
  },
  winter_snow: {
    groom: 'place the same person in a winter wedding portrait, charcoal wool coat suit, gentle snowfall, frosted trees, soft blue-white light, serene winter atmosphere, photorealistic, 8k',
    bride: 'place the same person in a winter bridal portrait, white fur-trimmed gown, gentle snowfall, frosted pine trees, soft blue-white winter light, magical serene beauty, photorealistic, 8k',
  },
  vintage_film: {
...
const COUPLE_PROMPTS: Record<string, string> = {
  ...
  city_night: 'place the same couple in a cinematic city night wedding scene, the man in tailored black tuxedo on the left, the woman in sleek white evening gown on the right, rain-slicked street reflecting neon and warm street lights, shallow depth of field, moody cinematic color grading, Wong Kar-wai inspired atmosphere, photorealistic, 8k',
  cherry_blossom: 'place the same couple in a cherry blossom wedding setting, the man in gray suit on the left, the woman in white dress on the right, couple looking at each other with gentle smiles, pink sakura petals falling around them, spring sunlight, dreamy pastel atmosphere, photorealistic, 8k',
  forest_wedding: 'place the same couple in an enchanted forest wedding setting, the man in dark suit on the left, the woman in ethereal white gown on the right, deep green forest with golden sunlight streaming through trees, white rose and ivy flower arch, floating light particles, magical romantic atmosphere, photorealistic, 8k',
  castle_garden: 'place the same couple in a dramatic European castle wedding, the man in classic black tailcoat on the left, the woman in grand white ball gown with cathedral train on the right, baroque palace with ornate columns and chandeliers, dramatic golden light streaming through tall windows, cinematic grandeur, photorealistic, 8k',
  cathedral: 'place the same couple in a romantic cathedral wedding ceremony, the man in charcoal morning suit on the left, the woman in classic ivory cathedral gown with long veil on the right, warm candlelight illuminating gothic arches, stained glass casting colorful light, white roses lining the aisle, intimate romantic atmosphere, photorealistic, 8k',
  ...
  rainy_day: 'place the same couple sharing a transparent umbrella in gentle rain, the man in dark navy coat suit on the left, the woman in white dress on the right, soft rain creating beautiful bokeh, wet cobblestone street reflections, intimate romantic mood, soft diffused overcast light, cinematic rain photography, photorealistic, 8k',
  autumn_leaves: 'place the same couple in an autumn wedding scene, the man in warm brown tweed suit on the left, the woman in ivory dress on the right, surrounded by golden red maple leaves, tree-lined avenue with fall foliage canopy, warm amber golden hour light, romantic cozy autumn atmosphere, photorealistic, 8k',
  winter_snow: 'place the same couple in a winter wonderland wedding, the man in charcoal wool coat suit on the left, the woman in white fur-trimmed gown on the right, gentle snowfall, frosted pine trees, soft blue-white winter light, breath visible in cold air, magical serene winter romance, photorealistic, 8k',
...
const generateSeeDream = async (snapId: string, concept: string, imageUrls: string[], mode: string) => {
  ...
  heart_editorial: 'wearing pure white architectural high mock-neck wedding dress with structured exaggerated square shoulders, rigid sculpted heavy white duchess satin torso like armor, front sharp straight column stopping at ankle, back dramatic floor-sweeping sculptural train of stiff white organza folds like origami paper, one single oversized red fabric heart pinned at center of chest like brooch, no lace no beading no tulle no soft draping, everything geometric and architectural, editorial high fashion',
    ...
    if (isCouple) {
      ...
      sdPrompt = 'Portrait 3:4 ratio. The same couple from the reference image. The man ' + gOutfit + '. The woman ' + bOutfit + '. ' + scene + '. Warm friendly natural expressions with genuine gentle smiles and kind soft eyes, relaxed comfortable intimate mood, NOT stern NOT cold NOT serious NOT expressionless NOT frowning. Photorealistic editorial photograph, soft natural skin texture with visible pores, warm natural skin tone, 50mm lens, shallow depth of field, no AI artifacts no plastic skin no uncanny valley';
    } else if (mode === 'groom') {
