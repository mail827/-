...
const SOLO_PROMPTS: Record<string, { groom: string; bride: string }> = {
  ...
  hanbok_dangui: {
    ...
    bride: 'place the same person in warm ondol room with yellow-ochre hanji walls, brass oil lamp on low wooden table, wearing ivory silk satin jeogori beneath sheer pale celadon organza dangui with wide flowing sleeves, deep plum goreum bow at chest, ivory chima with pale gold underlayer spread in perfect circle on hanji floor, gold calligraphy embroidery on dangui sleeve edge catching lamplight, black straight hair with plum silk ribbon, warm amber light, photorealistic, 8k, no Japanese kimono, no Chinese hanfu, no western suit, no blazer, no trench coat, no modern overcoat, accurate Korean hanbok structure, correct collar direction',
  },
  hanbok_modern: {
    ...
    bride: 'place the same person on mountain ridge shrouded in thick cold fog with dark pine silhouettes and dark wet rock, wearing cool dusty blue-grey silk jeogori with deep forest green goreum long tail, pale grey organza chima over blue-grey lining with sweep train on wet rock, standing in profile facing fog chin slightly raised, black straight hair with see-through bangs damp from fog, flat cool diffused fog light, contemporary minimalist Korean bridal attire, photorealistic, 8k, no Japanese kimono, no Chinese hanfu, no western suit, no blazer, no trench coat, no modern overcoat, accurate Korean hanbok structure, correct collar direction',
  },
  hanbok_saeguk: {
...
const generateSeeDream = async (snapId: string, concept: string, imageUrls: string[], mode: string) => {
  ...
  hanbok_wonsam: 'wearing deep crimson red silk duchesse satin jeogori with sharp geometric shoulders and clean straight neckline, single oversized gold silk goreum bow tied asymmetrically at chest with bow tails falling to waist, grand sweeping A-line ivory white silk organza chima over pale gold silk satin underlayer creating luminous warm glow, long dramatic train, wide deep crimson obi-like silk sash matching jeogori at waist, single thin border of hand-embroidered gold thread in delicate geometric palace window lattice pattern at hem, black straight hair with see-through bangs pulled back with simple gold binyeo hairpin, authentic Korean royal bride wedding attire',
  hanbok_dangui: 'wearing fitted ivory silk satin jeogori beneath sheer pale celadon green silk organza dangui overcoat open at front with wide flowing sleeves extending past fingertips, deep plum purple silk goreum bow tied elegantly at chest with tails falling past waist, grand full A-line ivory silk chima with pale gold silk satin underlayer and cathedral train, delicate gold thread calligraphy line embroidery along outer edge of celadon organza sleeves, black straight hair with see-through bangs tied back loosely with plum silk ribbon, refined elegant traditional Korean bridal attire',
  hanbok_modern: 'wearing cool dusty blue-grey silk jeogori fitted close to body with traditional curved closure and cropped high waist, single long deep forest green silk goreum tie with minimal knot and one long tail past waist, full flowing pale cool grey silk organza chima over dusty blue-grey satin lining with graceful sweep train, hidden warm blush pink silk inner wrist lining, black straight hair with see-through bangs, no embroidery no gold no pattern, contemporary minimalist Korean bridal attire',
