...
export const POSTER_CONCEPTS: PosterConcept[] = [
  {
    ...
    posterPrompt: `Portrait 3:4 ratio. Wide establishing shot from low angle. A vast open field with a single enormous cherry blossom tree in full bloom centered in the upper half of the frame against pale white sky. The couple stands small in the lower third of the frame, woman wearing ${OUTFIT_SPRING_BRIDE}, man wearing ${OUTFIT_SPRING_GROOM}. Cherry blossom petals drift across the field like slow pink snow. The tree canopy and sky occupy the upper 40 percent of the frame leaving generous negative space. Soft flat overcast light with no harsh shadows. Photorealistic, 24mm wide angle lens, deep depth of field, cinematic movie poster composition, 8k`,
  },
  {
    id: 'spring_tunnel',
    season: 'spring',
    ...
    outfitBride: OUTFIT_SPRING_BRIDE,
    outfitGroom: OUTFIT_SPRING_GROOM,
    posterPrompt: `Portrait 3:4 ratio. Wide establishing shot looking down a long tree-lined path. Cherry blossom trees on both sides form a dense pink canopy arch in the upper half of the frame. Fallen petals cover the ground like a pink carpet. The couple is small in the lower center of the frame riding an old bicycle through the tunnel of blossoms, woman wearing ${OUTFIT_SPRING_BRIDE} sitting sideways on rear rack skirt flowing, man wearing ${OUTFIT_SPRING_GROOM} pedaling, motion blur on wheels. The blossom canopy overhead fills the upper 40 percent creating natural text space. Warm golden late afternoon backlight filtering through petals. Photorealistic, 24mm wide angle lens, deep depth of field, cinematic movie poster composition, 8k`,
  },
  {
    id: 'spring_steps',
    season: 'spring',
  ...
  },
  {
    ...
    outfitBride: OUTFIT_AUTUMN_BRIDE,
    outfitGroom: OUTFIT_AUTUMN_GROOM,
    posterPrompt: `Portrait 3:4 ratio. Wide establishing shot of a small railroad crossing in a quiet town. The red and white barrier arm lowered horizontally across the frame. Autumn trees with deep orange and red leaves line both sides of the tracks forming a fiery canopy in the upper half of the frame. The couple stands small in the lower third one on each side of the barrier, woman in ${OUTFIT_AUTUMN_BRIDE}, man in ${OUTFIT_AUTUMN_GROOM}. They face each other across the barrier calmly. The burning autumn canopy and sky fill the upper 45 percent. Late afternoon golden light making leaves glow like fire. Photorealistic, 24mm wide angle lens, deep depth of field, cinematic movie poster composition, composed and resigned, 8k`,
  },
  {
    id: 'autumn_rooftop',
    season: 'autumn',
  ...
  },
  {
    ...
    outfitBride: OUTFIT_WINTER_BRIDE,
    outfitGroom: OUTFIT_WINTER_GROOM,
    posterPrompt: `Portrait 3:4 ratio. Wide establishing shot of an open snow field at night during heavy snowfall. Black sky fills the upper half of the frame. A single distant streetlamp far behind the couple creates a warm orange point of light in the upper background. The couple dances slowly in the lower third of the frame small in the vast white field, woman in ${OUTFIT_WINTER_BRIDE} ghostly against snow, man in ${OUTFIT_WINTER_GROOM} a dark shape against white. Foreheads pressed together. Snowflakes stretched into long white diagonal lines by slow shutter. The dark sky and falling snow fill the upper 50 percent. Photorealistic, 24mm wide angle lens, slow shutter motion blur, cinematic movie poster composition, analog film grain, a half-remembered dream in the cold, 8k`,
  },
  {
    id: 'winter_candles',
    season: 'winter',
