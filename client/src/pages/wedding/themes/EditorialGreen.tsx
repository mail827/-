...
export default function EditorialGreen({ wedding, guestbooks, onRsvpSubmit, onGuestbookSubmit, isRsvpLoading, isGuestbookLoading, guestPhotoSlot }: ThemeProps) {
  ...
  return (
    <div className="min-h-screen eg-pre" style={{ background: C.bg, overflowX: 'hidden' }}>
      ...
      <footer style={{ padding: '5rem 1.25rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <a href="https://weddingshop.cloud" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity" style={{ fontWeight: 300, fontSize: 10, color: C.dim, textDecoration: 'none', display: 'block', marginTop: '2rem' }}>Made by 청첩장 작업실 ›</a>
      </footer>
