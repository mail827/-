...
import { CONCEPT_LABELS } from '../utils/conceptLabels';
...
const CATEGORY_ORDER = [
  ...
  { key: 'FILM', label: '\ud544\ub984 \ub0b4\ub7ec\ud2f0\ube0c', ids: ['lovesick', 'silver_thread', 'summer_tape', 'rouge_clue', 'in_the_mood', 'summer_film', 'lily_choucho', 'nocturnal_animals', 'santorini_linen', 'age_of_innocence', 'blurred_spring', 'rosewater_ballet'] },
