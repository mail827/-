...
const CONCEPT_LABELS: Record<string, string> = {
  ...
  lovesick: '러브시크', silver_thread: '실버스레드', summer_tape: '서머테이프', rouge_clue: '루즈클루', in_the_mood: '화양연화',
...
const CATEGORY_ORDER = [
  ...
  { key: 'FILM', label: '\ud544\ub984 \ub0b4\ub7ec\ud2f0\ube0c', ids: ['lovesick', 'silver_thread', 'summer_tape', 'rouge_clue', 'in_the_mood'] },
