        ...
        <AnimatePresence mode="wait">
          {step === 0 && (
            <motion.div key="login" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="text-center py-12 space-y-8">
              <div>
                ...
                <h1 className="text-xl font-semibold text-stone-800 mb-2">AI 웨딩 화보</h1>
          ...
          {step === 2 && (
            <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
              ...
              <div className="flex gap-3">
                <button onClick={() => setStep(1)} className="px-6 py-3 rounded-lg border border-stone-200 text-sm text-stone-500 hover:bg-stone-50">이전</button>
                <button onClick={() => canProceed() && setStep(3)} disabled={!canProceed()}
                  className="flex-1 py-3 rounded-lg bg-stone-800 text-white text-sm font-medium disabled:opacity-30 hover:bg-stone-900 transition-all">다음</button>
              </div>
            </motion.div>
          )}
          ...
          {step === 3 && (
            <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
              <div className="text-center">
                <h2 className="text-xl font-semibold text-stone-800 mb-2">컨셉 선택</h2>
              ...
              <div className="flex gap-3">
                <button onClick={() => setStep(2)} className="px-6 py-3 rounded-lg border border-stone-200 text-sm text-stone-500 hover:bg-stone-50">이전</button>
            ...
            <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
              {generating ? (
                <div className="text-center py-20">
                  ...
                  <h2 className="text-lg font-semibold text-stone-800 mb-2">AI가 화보를 만들고 있어요</h2>
                ...
                <div className="text-center py-20">
                  ...
                  <button onClick={() => setStep(3)} className="mt-4 px-6 py-2 bg-stone-800 text-white rounded-lg text-sm">다시 시도</button>
                </div>
              )}
            </motion.div>
          )}
          ...
          {step === 5 && (
            <motion.div key="step5" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-12 space-y-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-stone-800 mb-2">무료 체험을 이미 사용했어요</h2>
