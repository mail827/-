          ...
          >
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col items-center gap-6">
                  ...
                  className="px-10 py-4 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white rounded-full text-sm hover:opacity-90 transition-all inline-flex items-center justify-center gap-3 font-medium"
                >
