        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-sm tracking-[0.2em] text-stone-500 mb-4">PREMIUM SERVICE</p>
              <h3 className="font-serif text-2xl md:text-3xl text-white mb-6">
                더 특별한 청첩장을 원하신다면
              </h3>
              <p className="text-stone-400 mb-8 leading-relaxed">
                세미커스텀, 풀커스텀, 시네마틱 영상까지<br />
                전담 매니저가 1:1로 함께합니다
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-10 max-w-xl mx-auto">
                <div className="bg-white/10 backdrop-blur rounded-xl p-5 text-left">
                  <p className="text-white font-medium mb-1">Standard</p>
                  <p className="text-stone-400 text-sm mb-2">세미커스텀 + 1~2분 영상</p>
                  <p className="text-white text-xl">85만원</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-5 text-left">
                  <p className="text-white font-medium mb-1">Premium</p>
                  <p className="text-stone-400 text-sm mb-2">풀커스텀 + 2~3분 시네마틱</p>
                  <p className="text-white text-xl">130만원</p>
                </div>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="https://open.kakao.com/o/sNEtHU7h"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-8 py-4 bg-white text-stone-800 rounded-full text-sm hover:bg-stone-100 transition-all inline-flex items-center justify-center gap-2"
                >
                  청첩장 문의 (oicrcutie)
                </a>
                <a
                  href="https://open.kakao.com/o/sJFmCzai"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-8 py-4 border border-white/30 text-white rounded-full text-sm hover:bg-white/10 transition-all inline-flex items-center justify-center gap-2"
                >
                  영상 문의 (토끼작업실)
                </a>
              </div>
          ...
          <div className="border-t border-stone-200 pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-stone-400">
              <div className="space-y-1">
                <p><span className="text-stone-500">상호</span> 청첩장 작업실</p>
