          ...
          <div style={{ position: 'fixed', inset: 0, zIndex: 60, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ position: 'relative', background: '#fff', borderRadius: 16, padding: '36px 32px', width: '100%', maxWidth: 380, margin: '0 16px', boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <button onClick={() => { const formData = { groomName, brideName, weddingDate, photos, videoMode, selectedConcept, selectedFont, selectedSubStyle, selectedBgm, venueName, groomFather, groomMother, brideFather, brideMother, endingMessage, metStory, step }; localStorage.setItem('pvFormData', JSON.stringify(formData)); localStorage.setItem('redirectAfterLogin', '/prewedding-video'); window.location.href = `${API}/oauth/kakao`; }} style={{ width: '100%', padding: '13px 0', background: '#FEE500', color: '#3C1E1E', borderRadius: 10, border: 'none', fontWeight: 600, fontSize: 14, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
